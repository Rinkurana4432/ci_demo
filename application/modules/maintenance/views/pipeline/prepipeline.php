<h3 class="Material-head">Preventive Checklist<hr></h3>
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>maintenance/updateprepipeline" enctype="multipart/form-data" id="similarmachine" novalidate="novalidate">
 ...
 <?php if(!empty($preventivepipeline)){

          $prechecklist =  json_decode($preventivepipeline->check_list);
    ...
    <input type="hidden" name="work_status" value='<?php echo $preventivepipeline->work_status; ?>'>
     ...
     <input type="hidden" name="worker" value='<?php echo $preventivepipeline->worker; ?>'>
     <input type="hidden" name="schedule_date" value='<?php echo $preventivepipeline->schedule_date; ?>'>
     <input type="hidden" name="shift" value='<?php echo $preventivepipeline->shift; ?>'>
     <input type="hidden" name="end_time" value='<?php echo $preventivepipeline->end_time; ?>'>
  ...
  <div class="item form-group">
    <div class="row" style="padding-top:20px;">
      ...
      <h3 class="Material-head">Material Details</h3>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <?php $materildetails = $preventivepipeline->material_detail; 
