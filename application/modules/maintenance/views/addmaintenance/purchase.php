...
<?php
   $this->companyGroupId = (isset($_SESSION['companyGroupSessionId']) && $_SESSION['companyGroupSessionId']!='' && $_SESSION['companyGroupSessionId'] != 0)?$_SESSION['companyGroupSessionId']:$_SESSION['loggedInUser']->c_id ;
   	...
   	?>	
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>maintenance/saveIndent" enctype="multipart/form-data" id="purchaseIndentForm" novalidate="novalidate">
   <!---------breakdown---------->
   <input type="hidden" name="breakdownid" value="<?php echo $purchasbreakdown->id; ?>">
   <input type="hidden" name="machine_name" value="<?php echo $purchasbreakdown->machine_name; ?>"> 
   <input type="hidden" name="machine_type" value="<?php echo $purchasbreakdown->machine_type; ?>"> 
   <input type="hidden" name="priority" value="<?php echo $purchasbreakdown->priority; ?>"> 
   <input type="hidden" name="requested_by" value="<?php echo $purchasbreakdown->requested_by; ?>"> 
   <input type="hidden" name="acknowledge" value="<?php echo $purchasbreakdown->acknowledge; ?>">
   <input type="hidden" name="aknowlwdge_by" value="<?php echo $purchasbreakdown->aknowlwdge_by; ?>">
   ...
   <input type="hidden" name="breakdown_couses" value="<?php echo $purchasbreakdown->breakdown_couses; ?>" id="loggedUser">   
   <!------------Breakdown---------------->  
