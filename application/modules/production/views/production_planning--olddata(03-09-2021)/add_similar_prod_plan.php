<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>production/saveProductionPlanning" enctype="multipart/form-data" id="productionPlan" novalidate="novalidate">
   ...
   <div class="col-md-6 col-sm-12 col-sx-12 vertical-border">
      <div class="item form-group">
         <label class="col-md-3 col-sm-12 col-xs-12" for="worker_name">Supervisor Name </label>
      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="form-control selectAjaxOption select2 select2-hidden-accessible select2 department" required="required" name="department_id"  tabindex="-1" aria-hidden="true" data-id="department" data-key="id" data-fieldname="name" data-where="created_by_cid=<?php echo $_SESSION['loggedInUser']->c_id; ?> AND unit_name = '<?php echo $production_plan->company_branch ; ?>'" >
   ...
   <div class="col-md-6 col-sm-12 col-sx-12 vertical-border">
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="radio">
               <label>
               <input type="radio" class="flat" name="shift" value="<?php echo $ps['id']; ?>" checked = checked[0] <?php if($production_plan->shift == $ps['id']){echo 'checked';} ?> ><?php echo $ps['shift_name']; ?></br>
               </label>
            </div>
            <?php }
               }}*/ ?>    
      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <input id="date" class="form-control col-md-2 col-xs-12 date" name="date" placeholder="date" required="required" type="text" value="<?php if($production_plan && !empty($production_plan)){echo $production_plan->date; }?>">
   ...
   <div class="item form-group">
      <div class="table table-striped dataTable rTable mainPlantable" id="prodPlan">
         <div class="app_div_planing_similar">
               ...
               $productionPlan = json_decode($production_plan->planning_data);
               	if(!empty($productionPlan)){
               		...
               		foreach($productionPlan as $prodplanData){
               			...
               			//$jobcard_data = getNameById('job_card',$prodplanData->job_no,'id');
         ...
         <form name="insert_worker_data" name="ins"  id="insert_worker_data_id">
            <div class="modal-body">
               ...
               <div class="item form-group col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-8 form-group">
                     <input type="text" id="salary" name="salary" class="form-control col-md-7 col-xs-12" value="" onkeypress="return float_validation(event, this.value)">
                     <span class="spanLeft control-label"></span>
                  </div>
               </div>
            </div>
