      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="radio_edit">
               <input type="radio" class="flat" name="shift" value="<?php echo $ps['id']; ?>" <?php if($convert_to_prodData->shift == $ps['id']){ echo 'checked'; }else{ echo 'checked = checked[0]'; }?>  ><?php echo $ps['shift_name']; ?></br>
            </div>
            <?php 		}
               }
               }
