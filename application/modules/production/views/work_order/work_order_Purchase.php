...
<?php
   ...
   $this->companyId = (isset($_SESSION['companyGroupSessionId']) && $_SESSION['companyGroupSessionId']!='' && $_SESSION['companyGroupSessionId'] != 0)?$_SESSION['companyGroupSessionId']:$_SESSION['loggedInUser']->c_id ;
      ...
      ?> 
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>production/saveIndent" enctype="multipart/form-data" id="purchaseIndentForm" novalidate="novalidate">
    <!---------breakdown---------->
               ...
               <div class="col-md-12 input_holder middle-box" id="div_result">
                  ...
                  <div class="well <?php if($i==0){ echo 'edit-row1';}else{ echo 'scend-tr mobile-view';}?>" style="overflow:auto; border-top: 1px solid #c1c1c1 !important;" id="chkIndex_<?php echo $i; ?>">
                     ...
                     <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                        ...
                        <select class="materialNameId form-control col-md-2 col-xs-12 selectAjaxOption select2 Add_mat_onthe_spot" name="material_name[]" data-id="material" data-key="id" data-fieldname="material_name" data-where="created_by_cid=<?php echo $_SESSION['loggedInUser']->c_id; ?> AND material_type_id = <?php echo $material_type;?>  AND status=1" onchange="getUom(event,this);">
                           <option value="">Select Option</option>
                           <?php
                              echo '<option value="'.$material_id.'" selected>'.$materialName->material_name.'</option>';
                              ?>
                        </select>
                     </div>
                      <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-md-2 col-sm-12 col-xs-6 form-group">
                           ...
                           <input type="text" id="quantity" name="quantity[]"  class="  form-control col-md-7 col-xs-12 qty " onkeyup="keyupFunction(event,this)" onchange="keyupFunction(event,this)" onkeypress="return float_validation(event, this.value)" value="<?php echo $qty; ?>" placeholder="Qty."  min="0" required="required"> 
                            <input type="text" id="uom" name="uom1[]" class="form-control col-md-7 col-xs-12 uom" readonly value="<?php
                              ...
                              echo $uom_name;
                              ?>">
                           <input type="hidden" name="uom[]" readonly class="uom1" value="<?php echo $uom_name; ?>">
                      </div>
                     <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                        <label>Expected Amount&nbsp;&nbsp;&nbsp;<span  style="color:red;"></span></label>
                         <input type="text" id="amount" name="price[]" class="form-control col-md-7 col-xs-12 key-up-event amount" keyup="keyupFunction(event,this)" onchange="keyupFunction(event,this)" placeholder="Exp Amt" min="0" onkeypress="return float_validation(event, this.value)" value="<?php echo $cost_price; ?>">
   ...
   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select  class="prefferedSupplier form-control col-md-2 col-xs-12 select2 add_more_Supplier" id="preffered_supplier"  name="preffered_supplier" data-id="supplier" data-key="id" data-fieldname="name" tabindex="-1" aria-hidden="true" data-where="created_by_cid=<?php echo $_SESSION['loggedInUser']->c_id; ?>">
