   ...
   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
      <div class="item form-group">
         ...
         <div  class="btn-group group-required" data-toggle="buttons">
            ...
            <h5>
            <strong>For Stock:
            <input type="radio" class="flat" name="stock_saleOrder" id="stock" value="stock" <?php if(!empty($work_order->stock_saleOrder) && isset($work_order->stock_saleOrder)){ echo $work_order->stock_saleOrder == 'stock' ?  "checked" : "" ;  }?> >
            For Sale order:
            <input type="radio" class="flat" name="stock_saleOrder" id="sale_order" value="sale_order" <?php if(!empty($work_order->stock_saleOrder) && isset($work_order->stock_saleOrder)){ echo $work_order->stock_saleOrder == 'sale_order' ?  "checked" : "" ;  }?>>
            </p>
         </div>
      </div>
   </div>
