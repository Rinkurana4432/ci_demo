               ...
               <table class="table table-striped  table-bordered user_index" data-id="user" border="1" cellpadding="3" data-order='[[1,"desc"]]'>
                  <thead>
                     <tr>
                        ...
                        <th scope="col">Account Name<a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=inprocess&sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=inprocess&sort=desc" class="down"></a></span></th>
                        <th scope="col">Product Details<a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=inprocess&sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=inprocess&sort=desc" class="down"></a></span></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td data-label="Product details:"><?php echo $materialName; ?></td>
                              ...
                              // }
							   ...
							   if(!empty($dispatch_date)){
                              	...
                              	foreach($dispatch_date->dispatch_date as $key=> $dispatch){
                                    ...
                                    if( isset($dispatch_date->approveby) ){
                        ...
                        <td data-label="Action :" class=" acc-btn">
                           ...
                           <button id="<?php echo $approved_saleOrder["id"]; ?>" data-id="set_dispatched_date" data-tooltip="Dispatch Date" class="productionTab btn btn-view  btn-xs" <?php echo $disableDispatch ; ?>><i class="fa fa-calendar-o"></i></button>
                           ...
                           <?php }else{ ?>
                           <?php } */ ?>
                           <!--button id="<?php echo $approved_saleOrder["id"]; ?>" data-id="create_work_order" data-tooltip="Work Order" class="productionTab btn btn-view  btn-xs" ><i class="fa fa-external-link-square"></i></button-->
						    <?php if (!empty($dispatch_date)): ?>
								 <button id="<?php echo $approved_saleOrder["id"]; ?>" data-id="create_work_order" class="productionTab btn btn-view  btn-xs" ><i class="fa fa-external-link-square"></i></button>
							  <?php endif ?>
                        </td>
                     </tr>
                     <?php
               ...
               <table style="width:100%" class="table table-striped table-bordered sale_order_index" data-id="account" border="1" cellpadding="3" data-order='[[1,"desc"]]'>
                  <thead>
                     <tr>
                        ...
                        <th scope="col">Account Name<span><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=complete&sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=complete&sort=desc" class="down"></a></span></th>
                        <th scope="col">Product<span><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=complete&sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/sale_order_with_production?tab=complete&sort=desc" class="down"></a></span></th>
                        <th scope="col">Order Date</th>
                        <th scope="col">Dispatched Date</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td data-label="Action:" class=" acc-btn"><?php echo '<a href="javascript:void(0)" id="'. $completedOrder["id"] . '" data-id="dispatched_order_view" data-tooltip="View" class="productionTab btn btn-view btn-xs" id="' . $completedOrder["id"] . '"><i class="fa fa-eye"></i>  </a>'; ?></td>
                     </tr>
                     <?php }
                        $saleorder  = $output;
