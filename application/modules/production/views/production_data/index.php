      ...
      <table id="" class="table table-striped table-bordered" border="1" cellpadding="3" style="width:100%;" data-order='[[1,"desc"]]'>
         <thead>
            <tr>
               ...
               <th scope="col">Date
                  <span><a href="<?php echo base_url(); ?>production/production_data?sort=asc" class="up"></a>
                  <a href="<?php echo base_url(); ?>production/production_data?sort=desc" class="down"></a></span><span class="resize-handle"></span>
               </th>
               <th scope="col">Shift
                  <span><a href="<?php echo base_url(); ?>production/production_data?sort=asc" class="up"></a>
                  <a href="<?php echo base_url(); ?>production/production_data?sort=desc" class="down"></a></span><span class="resize-handle"></span>
               </th>
               <th scope="col">Production Data<span class="resize-handle"></span></th>
         ...
         <tbody class="prodData">
            ...
            <tr>
               ...
               <td data-label="Shift:"><?php echo $production_data['shift_name'];?> </td>
                  ...
                  <!-- prodData -->
                     ...
                     <!------------ datatable-buttons ----------------->
                       ...
                       $jobCard = getNameById('job_card',$pwd->job_card_product_id[$i],'id');
                       ...
                       $material_name = $materialName_output->material_name;
                       $output_val = $pwd->output[$i][$out];
                      $set = $material_name.':- '.$output_val;
               ...
               <!--<td><button id="</?php echo $production_data['id']; ?>" data-id="AddSimilarProdData" data-tooltip="Add Similar Data" class="btn btn-xs productionTab add-machine"><i class="fa fa-plus"></i></button></td>-->
                <td data-label='Action:' class='hidde acc-btn action'><i class='fa fa-cog' aria-hidden='true'></i><div class='on-hover-action'>
                  <?php echo '<a href="'.base_url().'production/Add_SimilarProdData_edit?id='.$production_data['id'].'" class="
                     btn btn-delete btn-xs"  data-href="" >Add Sim. Production Data</a>'; ?>
                  <?php if($can_edit) 
                     echo '<a href="'.base_url().'production/production_data_edit?id='.$production_data['id'].'" class="
                        ...
                        if($can_delete) 
                        	echo '<a href="javascript:void(0)" class="delete_listing
                        		   btn btn-delete btn-xs"  data-href="'.base_url().'production/production_data_delete/'.$production_data['id'].'" >Delete</a>';
                        if($can_view) 
                        	echo '<button class="btn btn-view btn-xs productionTab" data-id="productView" id="'.$production_data["id"].'" data-toggle="modal" >View</button>';
                        ?>
					</div>
               </td>
            </tr>
