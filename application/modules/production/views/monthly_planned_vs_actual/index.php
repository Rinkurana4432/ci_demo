...
<div class="x_content">
   <div class="stik">
      <div class="col-md-12 ">
         <div class="col-md-6 datePick-right">
            <form action="<?php echo site_url(); ?>production/monthly_planned_vs_actual" method="get" id="export-form">
 ...
 <div class="Filter Filter-btn2">
      <form class="form-search " method="post" action="<?= base_url() ?>production/monthly_planned_vs_actual" >
			<div class="col-md-6">
...
<input type="text" class="form-control search-query" placeholder="Enter Id,Department" name="search" id="search" value="<?php if(!empty($_GET['search'])) echo $_GET['search'];?>" data-ctrl="production/monthly_planned_vs_actual">
					<span class="input-group-btn">
						<button type="submit" class="btn btn-purple btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
							Search
						</button>
      <a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
					</span>
				</div>
			</div>
			</form>	
	<button style="margin-right: 0px !important;" type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo"><i class="fa fa-filter" aria-hidden="true"></i>Filter By<span class="caret"></span></button>
     ...
     <div class="col-md-3 col-xs-12">
            ...
            <form action="<?php echo base_url(); ?>production/monthly_planned_vs_actual" method="get" id="date_range">	
   ...
   <div id="print_div_content" class="table-responsive"  style="margin-top: 58px;">
      ...
      <table class="table table-striped  table-bordered user_index" data-id="user" border="1" cellpadding="3" data-order='[[1,"desc"]]'>
         <thead>
            <tr>
               <th scope="col">Id<span><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=desc" class="down"></a></span></th>
               <th scope="col">Month<span><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=desc" class="down"></a></span></th>
               <th scope="col">Company Branch<span><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=desc" class="down"></a></span></th>
               <th scope="col">Department<span><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=asc" class="up"></a><a href="<?php echo base_url(); ?>production/monthly_planned_vs_actual?sort=desc" class="down"></a></span></th>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td data-label="Product Qty:"><?php echo '<button style="color:#fff;" type="buttton" class="btn btn-info productionTab addBtn" id="'.$ProductionReport['id'].'" data-toggle="modal" data-id="ProductionMonthlyPlannedVsActualReportQty">View Total Qty</button>'; ?></td>
               ...
               <td data-label="action:"> 
                 <!-- <button id="<?php echo $ProductionReport["id"]; ?>" data-id="ProductionReportAdd" data-tooltip="Edit" class="productionTab btn btn-view  btn-xs" ><i class="fa fa-edit"></i></button>-->
                  <?php echo '<a href="javascript:void(0)" id="'.$ProductionReport['id'].'" data-id="ProductionMonthlyPlannedVsActualReportView" class="productionTab btn btn-warning btn-xs" ><i class="fa fa-eye"></i> View </a>'; 
				  echo '<a href="javascript:void(0)" id="'. $ProductionReport["id"] . '"data-id="ProgessOfProduction" data-tooltip="Progess Gantt Chart of Work Order" class="productionTab btn btn-xs btn-edit"><i class="fa fa-line-chart" aria-hidden="true"></i></a>'
