     ...
     <form class="form-search " method="post" action="<?= base_url() ?>production/monthly_planned_vs_actual" >
         <div class="col-md-6">
            <div class="input-group">
               ...
               <input type="text" class="form-control search-query" placeholder="Enter Id,Department" name="search" value="<?php if(!empty($_GET['search'])) echo $_GET['search'];?>" data-ctrl="production/monthly_planned_vs_actual">
      ...
      <table class="table table-striped  table-bordered user_index" data-id="user" border="1" cellpadding="3" data-order='[[1,"desc"]]'>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td data-label="Product Qty:" style="color:#fff;"><?php echo '<button type="buttton" class="btn btn-info productionTab addBtn" id="'.$ProductionReport['id'].'" data-toggle="modal" data-id="ProductionMonthlyPlannedVsActualReportQty">View Total Qty</button>'; ?></td>
            ...
            <?php $output[] = array(   'Id' =>$ProductionReport['id'],
