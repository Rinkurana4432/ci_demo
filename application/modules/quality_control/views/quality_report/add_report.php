   ...
   <div class="col-md-12 col-sm-12 col-xs-12 ">
      <div class="item form-group">
         ...
         <div class="col-md-3 col-sm-3 col-xs-6">
            <input id="para" class="form-control col-md-7 col-xs-12" name="report_name" value="<?= 'Report_Name_'.getLastIdIncerment('quality_control'); ?>"  type="text" >		
         </div>
      </div>
      <div class="item form-group">
         <label class="col-md-3 col-sm-3 col-xs-12" for="instrument">No. of Observation <span class="required">*</span> </label>
         <div class="col-md-3 col-sm-3 col-xs-6">
            <input id="ins" class="form-control col-md-7 col-xs-12" name="observations"type="text" required="required" >
         </div>
      </div>
      <div class="item form-group">
         <label class="col-md-3 col-sm-3 col-xs-12" for="expectation">Per Lot Of Observation <span class="required">*</span></label>
         <div class="col-md-3 col-sm-3 col-xs-6">
            <input class="form-control col-md-7 col-xs-12" name="per_lot_of"   type="number" required="required" >
         </div>
      ...
      <table id="example" class="table table-striped table-bordered" border="1" cellpadding="3" data-order='[[1,"desc"]]'>
         ...
         <tbody>
            <tr>
               ...
               <td><input type="text" name="report[create1][parameter]"  style="width:70px"/></td>
               <td>
                  <select class="instrument  form-control selectAjaxOption select2" name="report[create1][instrument]"  width="100%" id="instrument" data-id="instrument" data-key="id" data-fieldname="name" data-where="created_by_cid=<?php echo $this->companyGroupId; ?>" tabindex="-1" aria-hidden="true" >
               ...
               <td>
                  <select class="uom  form-control selectAjaxOption select2" name="report[create1][uom1]"  width="100%" id="uom" data-id="uom" data-key="id" data-fieldname="uom_quantity" data-where="created_by_cid='0' || created_by_cid=<?php echo $this->companyGroupId; ?>" tabindex="-1" aria-hidden="true" >
                     <option>Select</option>
               ...
               <td><input type="number" class="exp" name="report[create1][expectation]"  style="width:70px" onkeyup="calculate(this)"  onclick="calculate(this)"/></td>
               <td><input type="number" class="min_dev" name="report[create1][deviation_min]" style="width:70px"  onkeyup="calculate(this)"  onclick="calculate(this)"/></td>
               <td><input type="number" class="max_dev" name="report[create1][deviation_max]" style="width:70px" onkeyup="calculate(this)"  onclick="calculate(this)"/></td>
               <td><input type="number" class="exp_min_dev" name="report[create1][exp_min_dev]" style="width:70px"  onkeyup="calculate(this)"  onclick="calculate(this)"readonly/></td>
               <td><input type="number" class="exp_max_dev" name="report[create1][exp_max_dev]" style="width:70px"  onkeyup="calculate(this)"  onclick="calculate(this)"readonly/></td>
               <td>	<button type="button" class="btn_danger" id="remove_row">x</button></td>
            </tr>
         </tbody>
      </table>
      <input type="hidden" id="inctr" value="2">
