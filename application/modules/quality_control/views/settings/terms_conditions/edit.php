...
?>
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>quality_control/saveterms_condtn" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
