 ...
 <?php $str = base64_decode('YW5vZGl6ZSQxMjNfQCMhQA==');
	...
	<div class="row">
				    <div class="col-md-3 datePick-right col-xs-12 ">
					  <button type="button" class="btn btn-primary qualityTab addBtn" data-toggle="modal" id="addins" data-id="AddGrn">Add New Report</button>						
										  </div>
...
<div id="print_div_content">  
    ...
    <a href="<?php base_url();?>/quality_control/delete_grn/<?php echo $val['id'];?>" class="btn btn-delete btn-xs " ><i class="fa fa-trash"></i>
    </a>
						</td>
		</tr>
