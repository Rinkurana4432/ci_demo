  ...
  <input type="hidden" name="status" id="status" value="<?php echo $process_data['types']['status'];?>"/>
            ...
            <i class="fa fa-2 fa-chevron-up pull-right process"></i>
                ...
                <div class="panel-body" style="height: 100px;" >
                    ...
                    $chk=$this->Quality_control_model->chk_usr('user','email',$pd['email']);
                  if($chk=='1'){?>
		...
		<div class="modal-dialog modal-lg modal-large">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="name" placeholder="both name(s) e.g Jon Doe" required="required" type="text" value="<?php $this->Quality_control_model->get_name('job_application',$pd['name'],'name');?>
">
										</div>											
									</div>											
									<div class="item form-group">												
										<label class="col-md-3 col-sm-3 col-xs-12" for="email">Email<span class="required">*</span></label>
										  <div class="col-md-6 col-sm-5 col-xs-12">												
											<input type="email" id="email" required="required" name="email"  class="form-control col-md-7 col-xs-12" placeholder="Enter email" value="<?php $this->Quality_control_model->get_name('job_application',$pd['name'],'email');?>">
										  </div>											
									</div> 
									<div class="item form-group">		
									...
									<div class="item form-group">													
										...
										<div class="col-md-6 col-sm-5 col-xs-12">														
											<input type="tel" id="telephone" name="contact_no" required="required" data-validate-length-range="8,10" class="form-control col-md-7 col-xs-12" placeholder="Enter mobile number" value="<?php $this->Quality_control_model->get_name('job_application',$pd['name'],'phone_no');?>">
										</div>												
									</div>
									<div class="item form-group">													
