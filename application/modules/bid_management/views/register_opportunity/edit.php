...
<?php if(!empty($attachments)){?>
   ...
   <div class="required item form-group col-md-12 col-sm-12 col-xs-12">
         ...
         <div class="required col-md-6 col-sm-12 col-xs-12">
            <select class="itemName form-control selectAjaxOption select2" id="account_id" name="account_id[]" data-id="bid_competitor_details" data-key="id" data-fieldname="name" onchange="getMatDetails()"  data-where="account_owner = <?php echo $this->companyGroupId ; ?> AND save_status = 1" width="100%">
