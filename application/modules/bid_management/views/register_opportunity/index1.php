...
<div class="stik">	
	...
	<?php /*if(!empty($leads) && $can_view){ ?><div class="col-md-6 col-sm-6 col-xs-12">
		...
		<div class="x_content">
			...
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
					<li role="presentation" class="active"><a href="#new_leads" role="tab" id="new_lead_tab" data-toggle="tab" aria-expanded="false">Key Info</a></li>
					</ul>
										...
										if($register_fr_opportunity['save_status'] == 0)
											...
											<img class="img-responsive hidde" src="'.base_url(). 'assets/images/draft.png" > </a>';
											   echo "<tr>											   
											   		...
											   		echo "</td>
													<td>".$draftImage . $register_fr_opportunity['id']."</td>
													<td>";
												...
												/*$output[] = array(
													   ...
													   'Name' => $in_process_lead['first_name'],
													   //'Buyer Order No.' => $buyer_order_no,
													   'Email' => $in_process_lead['email'],
													   'Phone No' => $in_process_lead['phone_no'],
