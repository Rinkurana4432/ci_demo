<?php
                     ...
                     <div class="col-md-6 col-sm-12 col-xs-12">						 
						...
						<div class="col-md-12 col-sm-12 col-xs-12 item form-group">													
							...
							<div class="col-md-6 col-sm-10 col-xs-12">													
										...
										<select class="itemName form-control selectAjaxOption select2 select2-hidden-accessible" name="assigned_to" required="required" data-id="user_detail" data-key="u_id" data-fieldname="name" data-where="c_id = <?php echo /*$_SESSION['loggedInUser']->c_id*/ $this->companyGroupId; ?>" width="100%" tabindex="-1" aria-hidden="true" required="required">
	...
	<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveAccount" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
		...
		<div class="item form-group col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-10 col-xs-12">
				<select class="itemName selectAjaxOption select2" name="parent_account" data-id="account" data-key="id" data-fieldname="name" data-where="account_owner = <?php echo /*$_SESSION['loggedInUser']->c_id*/ $this->companyGroupId; ?> AND save_status = 1" width="100%">
					<option value="">Select Option</option>
					<?php 
