...
<div id="print_div_content">
	...
	<table id="" class="table table-striped table-bordered account_index" data-id="account" style="width:100%" border="1" cellpadding="3">
		<thead>
			<tr>
				<th>All<br><input id="selecctall" type="checkbox"></th>
			<?php /* 	<th class="col-sm-1">Id</th>
				<th>Company Name</th>
				<th>Phone</th> */ ?>
				<?php
					 foreach($sort_cols as $field_name => $field_display){ ?>
						<th><?php echo anchor('crm/accounts/'.$field_name.'/'.($sort_by == $field_name ? $sort_order : 'asc').'/'.$page, $field_display); ?></th>
				<?php }?>
				<th>Created By</th>
				<th>Created Date</th>
