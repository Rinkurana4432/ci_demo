      ...
      <div class="col-md-12 export_div">
         ...
         <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <?php if($can_add) {
               ...
               //echo '<button type="button" class="btn btn-primary addBtn add_bid_mng_tabs" data-toggle="modal" id="add" data-id="register_opportunity_edit">Add</button>';
               echo '<button type="button" class="btn btn-success  add_bid_mng_tabs addBtn" data-toggle="modal" id="add" data-id="add_tender"><i class="fa fa-plus-circle valignmiddle btnTitle-icon"></i>Add</button>';
               } ?>
                     ...
                     <tbody>
                        <?php if(!empty($register_opportunity)){
                           ...
                           echo "<input name='checkbox[]' class='checkbox1 checkbox[]' type='checkbox' data-ai=".$register_fr_opportunity['id']."  value=".$register_fr_opportunity['id'].">";}
                           		   		...
                           		   		echo "</td>
                           				<td data-label='Tender Number:'>".$draftImage . $register_fr_opportunity['id']."</td>
                           				...
                           				<td data-label='Tender Status:'>";if($register_fr_opportunity['tender_status'] !='' && $register_fr_opportunity['tender_status'] != 0) 
                           {	
                           ...
                           <td data-label='Validate:' class='hidde".$can_validate."?'':'disabled''>"; 
                           ...
                           $output[] = array(
                           'Tender Number' => $register_fr_opportunity['id'],
                           ...
                           'Tender Status' =>$register_fr_opportunity['tender_status'],
                           'Status Comment' => $register_fr_opportunity['status_comment'],
                           'Created Date' => date("d-m-Y", strtotime($register_fr_opportunity['created_date'])),
                           				);	
                           }
                           		$data3  = $output;
