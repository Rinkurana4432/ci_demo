				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12 cdata">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 clogo">
							<img src="<?php echo base_url('assets/modules/company/uploads').'/'.(isset($company->logo) && $company->logo != '' ?$company->logo:"company-logo.jpg");?>" alt="Company logo" class="img-responsive" style="height:40px; width:100%;">
						</div>
										...
										<div class="row">						  
											<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>company/sendMessage" enctype="multipart/form-data" id="companyForm" novalidate="novalidate">
												...
												<div class="modal-footer">
													...
													<a href="<?php echo base_url().'company/non_connected_message'?>" title="Send this chat message" id="submit_message" class="btn btn-default btn-sm">Send</a>
												</div>
											</form> 
										</div>
									</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="row">
							...
							<?php if(!empty($products)){
										...
										$proImage  = $product['featured_image'] != ''?$product['featured_image']:"dummy_product.jpg";
								  ?>
									...
									<tbody>
										...
										<tr>
											<th colspan="2">
												...
												<?php }else{ echo 'No certificates uploaded'; } ?>	
											</th>
										</tr>
									</tbody>
								</table>
					...
					<?php if(!empty($connections)){
						...
						<div class="col-lg-3 col-md-6 col-sm-3 col-xs-3 con">
							<a href="<?php echo base_url().'company/view/'.$connection['id']; ?>">
								<img src="<?php echo base_url('assets/modules/company/uploads').'/'.($connection['logo'] != '' ?$connection['logo']:"dummyLogo.png");?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $connection['name']; ?>" class="img-responsive congal" alt="img">
							</a>
						</div>
						<?php } }else{
						...
						<div class="cproductSlider slider sliderm">
							...
							<div class="cpproduct col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="cpproduct-body">
									<h3 class="cpproduct-name"><a href="<?php echo base_url();?>"><?php echo $product['material_name'] ?></a></h3>
