<style>
#regForm {background-color: #fff0;}
#regForm input, #regForm textarea, #regForm select {padding: 10px 5px !important;width: 100%;font-size: 12px;border-bottom: 1px solid rgba(0,0,0,.2) !important; border: 0px;height: 35px;background-color: transparent !important;color: #000 !important;margin: 0px;
}
@media(min-width:768px)
{
.modal-for-pc{width: 40.7%; margin: 167px auto;}	
}
@media(max-width:767px)
{
.modal-body {padding-top: 0px !important;padding-bottom: 0px !important;}
.image-box-form .col-md-6 {width: 47%;float: left;}
.image-box-form, .form-box-register {display: unset;}	
}
</style>
                          ...
                          <div class="row" style="margin-top:20px;">
                           ...
                           <div class="col-md-12 text-center">                             
                             <form class="form" role="form" method="post" action="<?php echo base_url().'auth/auth_user'; ?>" accept-charset="UTF-8" id="login-nav">                                     
                              ...
                              <div class="form-group col-md-6 col-xs-5" style="padding-left: 0px;">                                          
                                <button type="submit" class="btn btn-primary btn-block btnerpyellow-stylefull">Sign in
                                </button>                                     
                              </div>                                       
                              <div class="col-md-6 bottom text-center col-xs-6">                               
...
function nextPrev(n) {
   ...
   if (response.length === 0) 
      {
        ...
        data: {'g-recaptcha-response': response,'key':'<?= RECAP_SITE_KEY ?>'}, // 6LdCx0wbAAAAAHTH8qfzeP8tDIMGOlY3UiM1eKmb change this to send js object
        type: "post",
   ...
   if(n==4){ 
      $('#tab4').css('display:block');    
         ...
         if(error){
            let htmlError = `<div class="row errorMsgForm" style="text-align: center;">
                                 <div class="col-md-12">
