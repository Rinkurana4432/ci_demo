...
<script>
  ...
  fbq('init', '353337536317151');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=353337536317151&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5RF7Z4V0XF"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-5RF7Z4V0XF');
</script>
        ...
        <div id="navbar" class="navbar-collapse collapse erpnavfont">
         <div class="hidden-xs col-sm-2 col-md-2 col-lg-2" >					
          ...
          <ul class="nav navbar-nav navbar-right">						
           ...
           <li class="">
              <a href="<?php echo base_url(); ?>lerp/blog/" class="erpnavlink ">Home
              </a>
            </li>
