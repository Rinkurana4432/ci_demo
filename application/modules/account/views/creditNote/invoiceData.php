...
<div class="col-md-12 input_descr_wrap label-box mobile-view2 row_head countRowHead">
   ...
   <div class="add_more_credit_note_row scend-tr mailing-box col-md-12" >
      <div class="item form-group col-md-1 col-sm-12 col-xs-12">
         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <input type="hidden" class="itemName form-control"   name="material_id[]" value="<?= $val->material_id ?>"  >
      ...
      <div class="item form-group col-md-1 col-sm-12 col-xs-12">
         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <input type="text"  required="required" name="quantity[]" class="form-control col-md-1 year goods_descr_section keyup_event_crnote" placeholder="Quantity" value="<?= $val->quantity ?>">
         </div>
      </div>
      <div class="item form-group col-md-1 col-sm-12 col-xs-12">
         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
      ...
      <div class="col-md-1 col-sm-12 col-xs-12 form-group">
         ...
         <div class="checktr">
            <!-- <select name="disctype[]" class="form-control disc_type_cls">
               ...
               <option value="disc_precnt" <?= ($val->disctype == 'disc_precnt' )?'selected':''; ?>>Discount Percent</option>
               <option value="disc_value" <?= ($val->disctype == 'disc_value' )?'selected':''; ?>>Discount Value</option>
            </select> -->
      ...
      <div class="item form-group col-md-1 col-sm-12 col-xs-12">
         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <input type="text" id="amount"   name="amount[]" class="form-control col-md-1 goods_descr_section AMunt" readonly placeholder="Amount" value="<?= $val->amount ?>" >
         </div>
      </div>
