								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<div class="col-md-12 col-sm-12 col-xs-12 form-group">
											...
											<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php if(!empty($delivery_data)) echo $delivery_data->challan_num; ?></div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 form-group">
										  <label scope="row">Challan Date</label>
										<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php if(!empty($delivery_data)) echo $delivery_data->challan_date; ?></div>
										</div>
										 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
										  <label scope="row">Receiver name</label>
										 <div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php
										  if(!empty($delivery_data)){
											  //$party_name = getNameById('ledger',$delivery_data->reciver_address,'id');
										...
										$party_name = getNameById('ledger',$delivery_data->reciver_name,'id');;
										 ...
										 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
										<?php
											// $party_ledger = getNameById('ledger',$delivery_data->reciver_address,'id');
										...
										<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php echo $locationArea->location; ?></div>
										</div>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-12 form-group label-left">	
								    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
...
<!-- <div class="ln_solid"></div>----->
	...
	<div class="form-group">
		...
		<?php if((!empty(delivery_data) && $delivery_data->save_status ==1)){ ?>
			<a href="<?php echo base_url(); ?>account/create_challan_pdfinward/<?php echo $delivery_data->id; ?>" target="_blank"><button class="btn btn-default">Generate PDF</button></a>
		<?php } ?>
