	...
	<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>account/saveChallan_Details" enctype="multipart/form-data"  novalidate="novalidate">
		<input type="hidden" value="<?php echo $_SESSION['loggedInUser']->u_id; ?>" id="login_user_idddd">
			<div class="col-md-12 col-sm-12 col-xs-12 form-group">
				...
				<input type="hidden" name="challan_in_out_wordType" value="0"><!-- 0 means outword Challan -->
						...
						<div class="item form-group">
							...
							<div class="item form-group">
								<label class="col-md-3 col-sm-12 col-xs-12" for="name">Branch Name<span class="required">*</span></label>
									<div class="col-md-6 col-sm-12 col-xs-12">
										<select class="itemName form-control selectAjaxOption select2"   name="branch_name" data-id="company_detail" data-key="id" data-fieldname="name" data-where="parent_cid=<?php echo $this->companyGroupId; ?>"  width="100%">
					...
					<div class="panel panel-default">
						...
						<div class="item form-group add-ro">
							...
							?>
								<div class="col-md-12 input_descr_wrap middle-box mailing-box mobile-view">
									...
									<div class="col-md-1 col-sm-12 col-xs-12 form-group">
									   <label class="col-md-12 col-sm-12 col-xs-12" for="quantity">Quantity<span class="required">*</span></label>
										<input type="text" name="quantity[]" required="required" class="form-control col-md-1 year goods_descr_section keyup_event_challan qty add_qty checkQtyByAddress" placeholder="Quantity" value="">
									</div>
									<div class="col-md-1 col-sm-12 col-xs-12 form-group">
                                         <label class="col-md-12 col-sm-12 col-xs-12" for="rate">Rate<span class="required">*</span></label>
										<div class="checktr">
							...
							<div class="col-md-2 col-sm-12 col-xs-12 form-group">
								...
								<div class="col-md-2 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-1 col-sm-12 col-xs-12 form-group">
									   <label class="col-md-12 col-sm-12 col-xs-12" for="quantity">Quantity<span class="required">*</span></label>
										<input type="text"  required="required" name="quantity[]" class="form-control col-md-1 year goods_descr_section keyup_event_challan checkQtyByAddress" placeholder="Quantity" value="<?php if(!empty($delivery_datas)){ echo $delivery_datas->quantity;} ?>" <?php if($delivery_data->auto_entry_po == 1){ echo"disabled";} ?>>
									</div>
									<div class="col-md-1 col-sm-12 col-xs-12 form-group">
                                        <label class="col-md-12 col-sm-12 col-xs-12" for="rate">Rate<span class="required">*</span></label>
										<div class="checktr">
						...
						<div class="col-md-1 col-sm-12 col-xs-12 form-group <?php if($delivery_data->challan_type == 0){ echo 'show_cls';} else{ echo 'hid_cls';}?>" >
							...
							$i++;
								...
								if($delivery_data->auto_entry_po == 1){
								?>

								<input type="hidden" value="<?php if(!empty($delivery_data)){ echo $delivery_data->auto_entry_po;} ?>"  name="auto_entry_po" id="auto_entry_po_id">
								<input type="hidden" value="<?php if(!empty($delivery_data)){ echo $delivery_data->puo_id;} ?>"  name="puo_id" id="challa_pur_ordr_no">
							<?php
							}
							}?>
