						...
						<div class="col-md-12 item form-group">
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-9 col-xs-12">
									<select class="itemName form-control selectAjaxOption select2 get_not_paid_purchase_bills"  required="required" name="party_id" data-id="ledger" data-key="id" data-fieldname="name" data-where="created_by_cid=<?php echo $this->companyGroupId; ?> AND save_status=1 AND activ_status = 1" width="100%" onchange="getEmail(this,event);">
					...
					<div class="col-md-6 col-sm-12 col-xs-12 form-group vertical-border">
						<div class="col-md-12 item form-group">
							...
							<label class="col-md-3 col-sm-3 col-xs-12">Payment From</label>
								<div class="col-md-6 col-sm-9 col-xs-12">
									<select class="form-control selectAjaxOption select2 recive_ledger_add"  required="required" name="recieve_ledger_id" data-id="ledger" data-key="id" data-fieldname="name" data-where="(created_by_cid=<?php echo $this->companyGroupId; ?>) AND save_status=1 AND activ_status = 1" width="100%">
										<option value="">Select</option>
											<?php
											if(!empty($payment_to_dtl)){
											...
											<?php
												if(!empty($payment_to_dtl)){
													...
													foreach($add_dtl as $ad_dtl_Sale){
														...
														$selected = ($ad_dtl_Sale['add_id'] == $payment_to_dtl->comp_branch_id) ? ' selected="selected"' : '';
						...
						<div class="col-md-12 item form-group">
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-9 col-xs-12">
									...
									<input type="text"  name="reference_no"  class="form-control col-md-7 col-xs-12" placeholder="Reference no" value="<?php if(!empty($payment_to_dtl)){ echo $payment_to_dtl->reference_no;} else { echo lastRefrenceNo('reference_no','payment'); } ?>" autocomplete="off">
								</div>
							</div>
						</div>
...
//pre($edit_Data);
										...
										<div class="col-md-12 input_descr_wrap app_div ">
											<div class="col-md-2 col-sm-12 col-xs-12 form-group">
												<input type="text" class="form-control" name="from_detail[]" value="<?php echo $edit_Data->from_detail; ?>" readonly>
											</div>
