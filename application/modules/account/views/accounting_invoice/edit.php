<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>account/saveAccounting_Invoice_Details" enctype="multipart/form-data" id="companyForm" novalidate="novalidate">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 input_fields_wrap">
					<div class="panel panel-default">
						...
						<div class="col-md-12 input_descr_wrap middle-box mailing-box mobile-view">
							<div class=" col-md-2 col-sm-12 col-xs-12 form-group item bad">
							...
							<div class="col-md-2 col-sm-12 col-xs-12 form-group item">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="form-group">
						...
						<center>
							...
							<?php if((empty($invoice_detail) && $invoice_detail->save_status ==0)){
