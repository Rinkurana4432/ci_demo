...
<div id="print_div_content"  style="margin-top: 4px;" >

       <?php $workername = getNameById('worker', $workerid, 'id');?>  <h1 style="text-align:center;"><b><?= $workername->name; ?></b>   </h1>  
...
?>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12 " style="clear:both; margin-top:22px; ">
        <div class="col-md-3 col-sm-5 col-xs-12 text-right grand-total3 bleow_hide" style="float: right;font-size: 22px;color: #252d2f;">
