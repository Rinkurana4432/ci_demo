   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <select name="company_id" class="itemName form-control" >
        ...
        if($_SESSION['loggedInUser']->role == 2 || $_SESSION['loggedInUser']->role == 3){
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="form-control selectAjaxOption select2 select2-hidden-accessible select2" id="suervisorID"  required="required" name="suervisorID"  tabindex="-1" aria-hidden="true" data-id="user_detail" data-key="id" data-fieldname="name" data-where="c_id=<?php echo $_SESSION['loggedInUser']->c_id;?> and is_activated=1" >
               <option value="">Select Option</option>
               <?php
                  if(!empty($workers)){
                     $userData = getNameById('user_detail',$workers->suervisorID,'id');
                     if(!empty($userData)){
