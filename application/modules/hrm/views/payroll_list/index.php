                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <button data-tooltip="View" class="btn btn-view btn-xs waves-effect waves-light PayslipGenerate" data-employeeId="<?php echo $individual_info->emp_id; ?>"  data-id="<?php echo $individual_info->pay_id; ?>"><i class="fa fa-eye"></i></button>
    ...
    <div class="modal-dialog modal-lg modal-large">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title chng_lbl nxt_cls" id="myModalLabel">Payroll List</h4>
            </div>
