...
<div class="item form-group">
     ...
     <label class="col-md-3 col-sm-12 col-xs-12" for="textarea" >Shift <span class="required">*</span></label>
       ...
       <div class="item form-group">
		...
		<div class="form-group">
         <label class="col-md-3 col-sm-12 col-xs-12">Employee Type <span class="required" style="color:red;">*</span></label>
         <div class="col-md-6 col-sm-12 col-xs-12">
	  ...
	  <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
			  ...
			  Worker: <input type="radio" class="flat" name="worker_supervisor"  value="0" <?php if(!empty($workers) && $workers->worker_supervisor == '0')  echo 'checked'; ?> required checked /> 
	...
	<?php } ?>
      <div class="item form-group">
	   ...
	   <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <input type="text" id="father_name" name="fathername" required="required" class="form-control col-md-7 col-xs-12" placeholder="Father Name" value="<?php if(!empty($workers)) echo $workers->fathername; ?>">
         </div>
      </div>
	  	<div class="item form-group">
 ...
 <!--  -->
   <?php if(!empty($workers->workerSlabData)){ 
               $salary_details = json_decode($workers->workerSlabData); 
               $total_sal=''; if(!empty($workers)){   $total_sal=$workers->salary; }
               ...
               $pf=''; if(!empty($salary_details->pf)){   $pf=$basic*$salary_details->pf/100;}else{$pf="0.00";}
            //$lwf=''; if(!empty($salary_details->lwf)){   $lwf=$total_sal*$salary_details->lwf/100;}else{$lwf="0.00";}
               ...
               $pf_employer=''; if(!empty($salary_details->pf_employer)){   $pf_employer=$basic*$salary_details->pf_employer/100;}else{$pf_employer="0.00";}
...
<input type="hidden" name="salarySlab" id="salarySlab" value="<?php if(!empty($workers->salarySlab)){ echo $workers->salarySlab;  } ?>" class="form-control" />
        ...
        <div id="pf_div" class="item form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12 vertical-border">
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <select class="itemName selectAjaxOption select2" name="salarySlab" id="salarySlabPer" data-id="salary_slab" data-key="id" data-fieldname="slabname" data-where="created_by_cid = <?php echo $_SESSION['loggedInUser']->c_id; ?> " width="100%">
                        <option value="">Select Option</option>
                        <?php 
