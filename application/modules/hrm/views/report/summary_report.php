...
<div class="x_content">
    <div class="col-md-12 col-sm-12 for-mobile">
         <div class="Filter Filter-btn2" style=" top: -82px;">
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                     ...
                     <div class="input-prepend input-group">
                        ...
                        <input type="text" style="width: 200px; height: 30px;" name="tabbingFilters" id="tabbingFilters" class="form-control" value="" data-table="dailyreport/dailyreport_adjustment">  
                         ...
                         ?>
                                       ...
                                       <tr>      
                                                ...
                                                /*  echo $end_date;
                                                  echo $start_date;
                                                */      
                                                   $e_l =   $this->hrm_model->get_emp_leave_per_emp_date_wise($val->emp_id, $c_id,$start_date,$end_date);
                                                 ...
                                                 #  pre($e_l); 
                                                   ...
                                                   $unpaid_leave = 0 ; 
                                                    foreach($e_l as $v){
                                                       # echo $v->typeid."<br>";
                                                         $leave_name = getNameById('leave_types',$v->typeid,'id');
                                                            
                                                     if(!empty($leave_name)){
                                                            if($leave_name->name == "LOP")
                                                            {
                                                                   $leave_hours = $v->leave_duration;
                                                                 $total_days_left =   $leave_hours/8;
                                                        $total_unpaid_leave =  round($total_days_left , 1);         
                                                                 $unpaid_leave = $unpaid_leave + $total_unpaid_leave;
                                                            ...
                                                            if($leave_name->name != "LOP"){
                                                                 $leave_hours = $v->leave_duration;
                                                                 $total_days_left =   $leave_hours/8;
                                                               $total_paid_leave =  round($total_days_left , 1);         
                                                                 $paid_leave = $paid_leave + $total_paid_leave;
                                                               }
                                                          }
                                                    }
                                                    
                                                    $paid_off = (float)$paid_leave;
                                                     $unpaid_leave = (float)$unpaid_leave;
                                                   #  $paid_off = @ (int)$e_l->present_date;
                                         /*   $dummy_paid_off    =     $workable_days - $p ;
                                                       ...
                                                       $total_unpaid_days = $workable_days - $total_paid_days + $unpaid_leave;   */
