      ...
      <table border="1" cellpadding="2">
         <tr>
            <td colspan="3" rowspan="2">
               ...
               <strong>Website :</strong><br/><?php echo $company_data->website; ?>
            </td>
         ...
         <tr>
            ...
            <td colspan="3"><strong>Mode / Terms Of Payment :</strong> &nbsp;<br/><?php echo $dataPdf->payment_terms; ?><br><br><strong>Payment Date :</strong> &nbsp;<br/><?php echo ($dataPdf->payment_date?(date("j F , Y", strtotime($dataPdf->payment_date))):'');?> </td>
            <br><br>
         </tr>
         <tr>
         ...
         <tr>
            <td><?php echo $no++; ?></td>
            <td>
               <h5><?php echo $materialName->material_name;?></h5>
               <br><?php echo (array_key_exists("description",$material_detail)?$material_detail->description:''); ?>
            </td>
         ...
         <?php 	
            ...
            ?>			  
         <tr>
            <td colspan="9">Amount Chargeable(in Words)<br><b><?php echo $result; ?> Only</b></td>
         </tr>
         <tr>
         ...
         <tr style="height:2000px">
            ...
            <td class="align-bottom"  valign="bottom" colspan="6" style="text-align:right;">
               for <?php echo  $company_data->name;?><br><br><br>(Authorized Signatory)
            </td>
         </tr>
      </table>
      <table>
         <br><br>
         <tr rowspan="2">
            <td  align="center"> This is computer generated Purchase Order does not require signature </td>
         </tr>
      </table>