      ...
      <div class="Filter Filter-btn2">
         <form class="form-search" method="GET" action="">
            <div class="col-md-6">
               <div class="input-group" style="float: right;">
                  <a href="<?php echo base_url(); ?>purchase/purchase_report/goods_receipt_forecast_report"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
               </div>
            </div>
         </form>
         ...
         <div id="demo" class="collapse" aria-expanded="false" style="height: 2px;">
            <div class="col-md-12  col-xs-12 col-sm-12 datePick-left">
               ...
               <form action="<?= base_url() ?>purchase/purchase_report/goods_receipt_forecast_report" method="GET" >
            ...
            <div id="print_div_content">
               <div class="table-responsive">
                  <table id="" style="width:100%;" class="table  table-bordered inprocess_div" data-id="user"  border="1" cellpadding="2" >
                        <?= table_th(['width: 193px;' => 'PO#','Material Code','Supplier Code','Requested Qty','Good Qty','Expected Delivery Date',
                        'Date Received','UOM','Signed By','Entered By']); ?>
                        <tbody>
                           <?php 
                              if( $poAnalysis ){
                                    ...
                                    foreach ($grnValue['material_data'] as $materialKey => $materialValue) {
                                     ?>
                                       <tr>
                                          ...
                                          <td><?= $materialValue['qty_delivered'] ?></td>
                                          <td><?= $grnValue['expected_delivery_date']??'N/A' ?></td>
                                          <td><?= $grnValue['mrnRDate'] ?></td>
                                          <td><?= $materialValue['uom']; ?></td>
