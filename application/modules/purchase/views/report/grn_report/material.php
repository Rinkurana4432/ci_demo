      ...
      <div class="Filter Filter-btn2">
         <form class="form-search" method="GET" action="">
            <div class="col-md-6">
               <div class="input-group" style="float: right;">
                  <a href="<?php echo base_url(); ?>purchase/purchase_report/grn_material_report"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
               </div>
            </div>
         </form>
         ...
         <div id="demo" class="collapse" aria-expanded="false" style="height: 2px;">
            <div class="col-md-12  col-xs-12 col-sm-12 datePick-left">
               ...
               <form action="<?= base_url() ?>purchase/purchase_report/grn_material_report" method="GET" >
            ...
            <div id="print_div_content">
               <div class="table-responsive">
                  <table id="" style="width:100%;" class="table  table-bordered inprocess_div" data-id="user"  border="1" cellpadding="2" >
                        <?= table_th(['Material Type','Material Code','Material','UOM','Price','Create Date']); ?>
                        <tbody>
                           <?php 
                              if( $mData ){
                                 foreach ($mData as $mDateKey => $mDateValue) { ?>
                                       <tr>
                                          <td class="supplierCode tdTextCenter" >
                                             <span>
                                                <?= $mDateValue['material_type']; ?>
                                             </span>
                                          </td>
                                           <td class="poOrderCode">
                                                <?= $mDateValue['material_code']; ?>
                                          </td>
                                          <td class=""><?= $mDateValue['material_name']; ?></td>
                                          <td class=""><?= $mDateValue['uom']; ?></td>
                                          <td class=""><?= $mDateValue['price']; ?></td>
                                          <td><?= $mDateValue['create_date']; ?></td>
                                       </tr>
                              <?php      
                                 }
                              }
