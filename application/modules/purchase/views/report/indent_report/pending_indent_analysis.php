      ...
      <div class="Filter Filter-btn2">
         <form class="form-search" method="GET" action="">
            <div class="col-md-6">
               <div class="input-group" style="float: right;">
                  <a href="<?php echo base_url(); ?>purchase/purchase_report/pending_indent_analysis"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
               </div>
            </div>
         </form>
         ...
         <div id="demo" class="collapse" aria-expanded="false" style="height: 2px;">
            <div class="col-md-12  col-xs-12 col-sm-12 datePick-left">
               ...
               <form action="<?= base_url() ?>purchase/purchase_report/pending_indent_analysis" method="GET" >
                  <div class="row hidde_cls filter1 progress_filter">
                     <div class="btn-group"  role="group" aria-label="Basic example">
                        <select class="form-control supp_name disbled_cls select_supplier commanSelect2" name="company" >
                           <?= $company ?>
                        </select>
                     </div>
            ...
            <div id="print_div_content">
               <div class="table-responsive">
                  <table id="" style="width:100%;" class="table  table-bordered inprocess_div" data-id="user"  border="1" cellpadding="2" >
                        <?= table_th(['Indent No.','Supplier Code','width: 40em;' => 'Indent Material','Grand Total','Created By','Created Date','Company']); ?>
                        <tbody>
                           <?php 
                              if( $poAnalysis ){
                                 ...
                                 foreach ($poAnalysis as $grnKey => $grnValue) {
                                     ?>
                                       <tr>
                                          ...
                                          <td><?= getSingleAndWhere('company_unit','company_address',['compny_branch_id' => $grnValue['company_unit']]); ?></td>
                                       </tr>
                              <?php       
                                 }
                              }
