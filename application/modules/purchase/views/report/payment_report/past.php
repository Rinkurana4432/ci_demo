      ...
      <div class="Filter Filter-btn2">
         <form class="form-search" method="GET" action="">
            <div class="col-md-6">
               <div class="input-group" style="float: right;">
                  <a href="<?php echo base_url(); ?>purchase/purchase_report/past_paymant_report"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
               </div>
            </div>
         </form>
         ...
         <div id="demo" class="collapse" aria-expanded="false" style="height: 2px;">
            <div class="col-md-12  col-xs-12 col-sm-12 datePick-left">
               ...
               <form action="<?= base_url() ?>purchase/purchase_report/past_paymant_report" method="GET" >
            ...
            <div id="print_div_content">
               <div class="table-responsive">
                  <table id="" style="width:100%;" class="table  table-bordered inprocess_div" data-id="user"  border="1" cellpadding="2" >
                        <?= table_th(['Supplier Name','Supplier Code','Payment Type','Payment Date','Amount']); ?>
                        <tbody>
                           <?php if( $paymentData ){
                              foreach ($paymentData as $key => $value) { ?>
                                 <tr>
                                    <td class="purchaseOrderTd tdTextCenter"><span><?= $value['supplier_name'] ?></span></td>
                                    <td class="purchaseOrderTd tdTextCenter"><span><?= $value['supplier_code'] ?></span></td>
                                    <td><?= $value['payment_terms']??'N/A' ?></td>
                                    <td><?= $value['payment_send'] ?></td>
                                    <td><?= $value['amount'] ?></td>
                                 </tr>
