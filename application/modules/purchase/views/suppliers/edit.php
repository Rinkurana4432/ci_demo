...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>purchase/saveSupplier" enctype="multipart/form-data" id="supplierForm" novalidate="novalidate">
   ...
   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <select class="itemName form-control selectAjaxOption_account_group_accordingly select2 cls_add_select2 opt_Data select2-width-imp" id="select2Opt" required="required" name="supp_account_group_id">
   ...
   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="itemName form-control selectAjaxOption select2 select2-hidden-accessible country_id select2-width-imp" name="country" data-id="country" data-key="country_id" data-fieldname="country_name" width="100%" tabindex="-1" aria-hidden="true"  onchange="getState(event,this)">
      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="itemName form-control selectAjaxOption select2 select2-hidden-accessible state_id select2-width-imp" name="state"  width="100%" tabindex="-1" aria-hidden="true"  onchange="getCity(event,this)">
               <option value="">Select Option</option>
               <?php
                  if(!empty($suppliers)){
      ...
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="itemName form-control selectAjaxOption select2 select2-hidden-accessible city_id select2-width-imp" name="city" width="100%" tabindex="-1" aria-hidden="true">
               <option value="">Select Option</option>
               <?php
                  if(!empty($suppliers)){
	   ...
	   <div id="Material-List" class="tab-pane fade in active">
	      <div >
	         <div class="input_fields_wrap_supplier">
	            <div class="goods_descr_wrapper checkWell">
	                <div>
	                    <div class=" input_holder middle-box col-md-12" >
						   <div class="col-sm-12  col-md-12 label-box mobile-view2">
						      <label class="col-md-6 col-sm-12 col-xs-12 ">Material Name</label> 
						      <label class="col-md-4 col-sm-12 col-xs-12 ">UOM</label>	
						      <!--label class="col-md-2 col-sm-12 col-xs-12 ">Date</label-->
						      <label class="col-md-2 col-sm-12 col-xs-12 ">Price</label>
						   </div>
                     <?php $this->load->view('supplierMaterial',$suppliers); ?>
							<div class="col-sm-12 btn-row">
						   		<button class="btn edit-end-btn addMoreMaterials addMorefileds" style="margin-top: 23px;"type="button">Add</button>
						   	</div>
						</div>
	                </div>
	            </div>
   ...
   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
      <div class="item form-group">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            <select class="bankName form-control selectAjaxOption select2 select2-hidden-accessible bank_id select2-width-imp" name="bank_name" data-id="bank_name" data-key="bankid" data-fieldname="bank_name" width="100%" tabindex="-1" aria-hidden="true" >
               <option value="">Select Option</option>
               <?php
                  if(!empty($suppliers)){
   ...
   <div class="form-group">
      <div class="col-md-12 col-xs-12">
         <center>
            ...
            <button type="reset" class="btn edit-end-btn " onclick="Reset();" >Reset</button>
            ...
            <div class="modal-body">
			 <div class="item form-group col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-8 form-group">
                    <select class="selectAjaxOption select2 form-control select2-width-imp" name="material_type_id" data-id="material_type" data-key="id" data-fieldname="name" width="100%" id="material_type_id" data-where="created_by_cid = <?php 	echo $_SESSION['loggedInUser']->c_id; ?> OR created_by_cid = 0">
                        <option value="">Select Option</option>
...
<script type="text/javascript">
    function Reset() {
		...
		$('.selectAjaxOption_account_group_accordingly').val('').trigger('change');
		$('.selectAjaxOption').val('').trigger('change');
        // var dropDown = document.getElementsByClassName("selectAjaxOption_account_group_accordingly");
