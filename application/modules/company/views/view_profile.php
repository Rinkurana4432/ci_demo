					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="row">
							...
							<?php if(!empty($products)){
										...
										$proImage  = $product['featured_image'] != ''?$product['featured_image']:"image-placeholder.jpg";
								  ?>
						...
						<div class="cproductSlider slider sliderm">
							...
							<div class="cpproduct col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="cpproduct-body">
									<h3 class="cpproduct-name"><a href="<?php  echo base_url(); ?>home/product_detail?material_id=<?php echo $product['id'];  ?>&company_id=<?php echo $product['created_by_cid'];  ?>"><?php echo $product['material_name'] ?></a></h3>
									<?php $countRating = getStarRatingCount('reviews',$product['id'],'material_id'); 
														//pre($countRating);
														if(!empty($countRating)){
