...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>company/save_company_department" enctype="multipart/form-data" id="myform" novalidate="novalidate">
	...
	<?php
		...
		<div class="item form-group">
			<div class="col-md-6 col-sm-6 col-xs-12 " style="margin-bottom:10px;">  
				<select class="form-control col-md-2 col-xs-12 selectAjaxOption select2" required="required" name="unit_name" data-id="company_address" data-key="compny_branch_id" data-fieldname="company_unit" tabindex="-1" aria-hidden="true" data-where="created_by_cid=<?php echo $this->companyGroupId; ?>">
			...
			<div class="ln_solid"></div>
				<div class="form-group">
					<div class="col-md-6 col-md-offset-3">
						...
						<a class="btn btn-danger" onclick="location.href='<?php echo base_url();?>company/company_setting'">Cancel</a>
					</div>
				</div>
</form>