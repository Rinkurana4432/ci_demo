<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>inventory/saveInventoryListing" enctype="multipart/form-data" id="inventory_listing" novalidate="novalidate">
	<input type="hidden" name="id" value="<?php if($inventoryListing && !empty($inventoryListing)){ echo $inventoryListing->id; }?>">
		...
		<!--<div class="item form-group">
				<div style="font-size:20px;" class="consumed_mat_name">Product Name:<b><span  id="material_name" style="color:green;"></span></b></div>
		</div>-->	
		<h3 class="Material-head consumed_mat_name">Product Name:<b><span  id="material_name" style="color:green;"></span><hr></h3>
		<div class="item form-group">
...
<div class=" vertical-border col-md-8" style="clear: both;">
		<div class="item form-group">
			<label class="col-md-3 col-sm-3 col-xs-12" for="mat_name">Consumed<span class="required">*</span></label>
				<div class="col-md-4 col-sm-6 col-xs-12">
					<input type="number" id="qty" name="quantity" required="required" class="form-control col-md-7 col-xs-12 keyup_check_qty" placeholder="consumed" value="<?php //echo $inventoryAdjustment['uom']; ?>">
				</div>
				<div class="col-md-4 col-sm-6 col-xs-12">
