							...
							<div class="" role="tabpanel" data-example-id="togglable-tabs">
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<div class="col-md-12 col-sm-12 col-xs-12 form-group">
											<label scope="row">Challan Number</label>
											<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php if(!empty($delivery_data)) echo $delivery_data->challan_number; ?></div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 form-group">
										  <label scope="row">Purchase Order No.</label>
										<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php 
										$PO_details = getNameById('purchase_order',$delivery_data->challa_pur_ordr_no,'id');
									
										if(!empty($PO_details)) echo $PO_details->order_code; 
										
										?></div>
										</div>
										 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
										  <label scope="row">Party</label>
										 <div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php
										 ...
										 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
										<?php
											$party_ledger = getNameById('ledger',$delivery_data->party_name,'id');
								...
								<div class="col-md-6 col-sm-6 col-xs-12 form-group label-left">	
								    <!--div class="col-md-12 col-sm-12 col-xs-12 form-group">
										...
										<div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php  //if(!empty($delivery_data->vehicle_reg_no)){ echo $delivery_data->vehicle_reg_no;}else{echo 'N/A';} ?></div>
									</div>
									<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									  <label scope="row">Transport Tel No</label>
									  <div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php  //if(!empty($delivery_data->transporter_phone)){ echo $delivery_data->transporter_phone;}else{echo 'N/A';} ?></div>
									</div>
									 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
									  <label scope="row">Terms of Delivery</label>
									  <div class="col-md-7 col-sm-12 col-xs-6 form-group"><?php //if(!empty($delivery_data->terms_of_delivery)){ echo $delivery_data->terms_of_delivery;}else{echo 'N/A';} ?></div>
									</div-->
									<div class="table-responsive">
										<table class="table table-striped">
									    <div class="label-box mobile-view3">
										  ...
										  <?php
											$invoice_matrial_details = json_decode($delivery_data->material_descr,true);
											 ...
											 <div class="col-md-4 col-sm-5 col-xs-12 text-right" style="float: right;">
												<div class="col-md-12 col-sm-12 col-xs-12 text-right grand-tota2">
													<div class="col-md-6 col-sm-5 col-xs-6 form-group">
														...
														<div class="col-md-6 text-left form-group"><?php echo money_format('%!i',$delivery_data->challan_totl_amt); ?></div>	
													</div>
													</div>
										</div>     
								</table>
...
<div class="form-group">
		...
		<?php //if((!empty($delivery_data) )){ ?>
			<!--a href="<?php //echo base_url(); ?>inventory/create_third_party_inv_pdf/<?php //echo $delivery_data->id; ?>" target="_blank"><button class="btn btn-default">Generate PDF</button></a-->
		<?php //} ?>
