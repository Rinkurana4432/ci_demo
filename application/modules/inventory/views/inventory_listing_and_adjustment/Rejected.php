<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>inventory/saveInventoryListingAdjustment"
                ...
                <div class="panel panel-default">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered jambo_table bulk_action"
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="col-md-2 item form-group">
                                    <label class="col-md-12 col-sm-12 col-xs-12" for="rack">Rack number</span></label>
                                </div>
                            </th>

                            <th>
                                <div class="col-md-2 item form-group">
                                    <label class="col-md-12 col-sm-12 col-xs-12" for="rack">Lot No.</span></label>
                                </div>
                            </th-->
                     ...
                     foreach($inventoryListing as $source_Data){
                        if(!empty($source_Data['Qtyuom'])){
                        $ww =  getNameById('uom',$source_Data['Qtyuom'],'id');
                        } else {
                        $ww =  getNameById('uom',$material_uom,'id');   
                        }
                        ...
                        <tr id="Index_<?php echo $i; ?>">
                            ...
                            <!--td>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <input type="hidden" id="area" name="source_storage[]"
                                        class="form-control col-md-7 col-xs-12" placeholder="area"
                                        value="</?php if(!empty($source_Data)) echo $source_Data['Storage']; ?>">
                                    <span></?php echo  $source_Data['Storage'];  ?></span>
                                </div>
                            </td>
                            <td>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <input type="hidden" id="rack_number" name="source_rack_no[]"
                                        class="form-control col-md-7 col-xs-12" placeholder="rack number"
                                        value="</?php if(!empty($source_Data)) echo $source_Data['RackNumber']; ?>">
                                    </?php if(!empty($source_Data)) echo $source_Data['RackNumber']; ?>
                                </div>
                            </td>
                            <td>
                                <input type="hidden" id="lot_no" name="source_lotno[]"
                                    class="form-control col-md-7 col-xs-12" placeholder="Lot No"
                                    value="</?php if(!empty($source_Data)) echo $source_Data['lot_no']; ?>">
                                    <span>
                                    </?php 
    ...
    <div class="col-md-6 col-xs-12 col-sm-12 vertical-border">
        <div class="item form-group">
            <label class="col-md-3 col-sm-3 col-xs-12" for="mat_name">Rejected Qty</label>
            <div class="col-md-3 col-sm-6 col-xs-12">
                <input type="text" id="qty" name="quantity" required="required" class="form-control col-md-7 col-xs-12"
                    placeholder="Rejected Qty" value="<?php //echo $inventoryAdjustment['uom']; ?>"
