								...
								<div class="col-md-6 col-sm-12 col-xs-12 vertical-border">	
								<div class="item form-group">
								<label class="col-md-3 col-sm-3 col-xs-12" for="code">Issue date. <span class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="date" name="record_date" id="acknowledge" required="required" class="form-control col-md-7 col-xs-12 req_date currentDateTime" value="<?php echo date('d-m-yy'); ?>" style="z-index: 9999;">	
								</div>	
								</div>	  
								</div>	  
								<div class="item form-group ">
								...
								<div class="col-md-2 col-sm-6 col-xs-12 form-group"><label>Product Type <span class="required">*</span></label></div>
								<div class="col-md-1 col-sm-6 col-xs-12 form-group"><label>Product name <span class="required">*</span></label></div>
								
								<div class="col-md-1 col-sm-6 col-xs-12 form-group"><label>Quantity <span class="required">*</span></label></div>
								...
								<select class="form-control selectAjaxOption select2 select2-hidden-accessible material_type_id select2 add_material_cls materialTypeId requiredData"   name="material_type_id_<?=$j;?>[]" data-id="material_type" data-key="id" data-fieldname="name" data-where="created_by_cid=<?php echo $this->companyGroupId; ?> OR created_by_cid=0" tabindex="-1" aria-hidden="true" onchange="getMaterialName(event,this)" id="material_type" re>
								<option value="">Select Option</option>
								...
								<input type ="text"  id="qty" name="qty_<?=$j;?>[]"  class="form-control col-md-7 col-xs-12 keyup_event" placeholder="quantity" value="<?php if(!empty($workinpromatall->quantity)){ echo $workinpromatall->quantity; } ?>" placeholder="Qty" readonly required>
								<input type="hidden" class="issued_quantity" name="issued_quantity_<?=$j;?>[]"  value="<?php echo $workinpromatall->issued_quantity;?>">
								<input type="hidden" class="required_quantity" name="required_quantity_<?=$j;?>[]"  value="<?php echo $workinpromatall->required_quantity;?>">
								</div>
								<div class="col-md-1 col-sm-6 col-xs-12 form-group"> 
								...
								<input  type="hidden" id="uom" name="uom_<?=$j;?>[]" class="form-control col-md-7 col-xs-12 uom" value="<?php echo $workinpromatall->uom?>"  placeholder="uom">
								</div>
								<div class="col-md-1 col-sm-6 col-xs-12 form-group">
