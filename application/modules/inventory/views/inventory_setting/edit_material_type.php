...
<div class="col-md-6 col-xs-12 col-sm-12 vertical-border">
		<div class="item form-group">
			<label class="col-md-3 col-sm-3 col-xs-12" for="code">Product Type </label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input id="material_type" class="form-control col-md-7 col-xs-12" name="name" placeholder="Product type" type="text" value="<?php if(!empty($materialType)) echo $materialType->name;?>" id="material_type" <?php if(!empty($materialType) && $materialType->created_by_cid == 0 ) echo 'readonly'; ?>  required="required" style="z-index: 99999;">
				</div>
		</div>
		
</div>
<div class="col-md-6 col-xs-12 col-sm-12 vertical-border cls_display_none">
    <div class="item form-group">
		...
		<div class="item form-group">
			...
			<h3 class="Material-head cls_display_none" for="material_list"><strong>Sub Type(if any:) </strong><hr></h3>
			...
			<div class="col-md-8 col-sm-6 col-xs-12 add_sub_type " style="margin: 0px auto;float: unset;">
					...
					<div class="well"  id="chkIndex_1">
						<div class="col-md-12 col-sm-6 col-xs-12 input-group vertical-border" >
							...
							<div class="col-md-8">	
							<input id="material_sub_type" class="form-control col-md-7 col-xs-12 materialSubType" name="material_sub_type[]" placeholder="Sub Type" type="text" value="" id="material_sub_type">
							</div>
						</div>
				   ...
				   <div class="well" style="overflow:auto;" id="chkIndex_1">
						<div class="col-md-12 col-sm-6 col-xs-12 input-group vertical-border">
							<label class="col-md-3">Sub type</label>
							   <div class="col-md-8">
								<input id="material_sub_type" class="materialSubType form-control col-md-7 col-xs-12" name="material_sub_type[]" placeholder="Sub Type" type="text" value="<?php echo $sub_typeName; ?>" id="material_sub_type" required="required" >
								</div>
						</div>
						<?php if($i==1){
