		...
		<div class="item form-group ">
            <div class="col-md-12 col-sm-12 col-xs-12 recv_finish_goods_add">
				<div class="panel panel-default" style="overflow: hidden; padding-bottom: 35px;">
					...
					<h3 class="Material-head">Received Finish Goods<span id="mat_msg" style="color: red;font-size: 13px;text-align: center;width: 100%;display: block;"></span><hr></h3>
						<div >
							...
							<div class="col-md-12 middle-box2">
									<div class="well" id="chkIndex_1" style="overflow:auto;" >
											...
											<div class="col-md-3 col-sm-3 col-xs-12" for="mat_name">Job Card</div>
										...
										<div class="item form-group abc" style="border-top:1px solid #c1c1c1 !important; clear: both;">
										   <div class="label-box mobile-view2">
												...
												<div class="col-md-3 item form-group" style="border-right:1px solid #c1c1c1 !important;">
										...
										<div class="btn-row">	
											<div class="input-group-append">
												<button class="btn edit-end-btn add_more_finish_goods" type="button">Add</button>
											</div>
										</div>	
									</div>	
								</div>	
