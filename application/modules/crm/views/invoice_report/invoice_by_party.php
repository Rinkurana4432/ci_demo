...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/invoice_by_party" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="btn-group" role="group" aria-label="Basic example">
          <a href="<?php echo base_url(); ?>crm/invoice_by_party" class="Reset-btn btn btn-success">
        Reset
         </a>
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/invoice_by_party" method="get" id="export-form">
         ...
         <thead>
            ...
            <?php if(!empty($invoices11)){
						...
						?>
									  <tr>
                          <td> 
                            <?php if($i == 1){echo $aowner_name." (".$total.")"; } ?>         
                          </td>
