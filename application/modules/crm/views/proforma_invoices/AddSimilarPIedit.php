...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveSimilarPI" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
	...
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<input id="Purchase_code" class="form-control col-md-7 col-xs-12" name="piCode" type="text" value="<?php  echo $piCode; ?>" readonly>
		</div>
	</div>
	</div>
 ...
 <div id="Customer-Details" class="container tab-pane "> 
      <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	     <div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">								
								<input type="text" id="gstin" name="gstin" class="form-control col-md-7 col-xs-12 gstin" value="<?php if(!empty($pi) && !empty($account)) echo $account->gstin; ?>" onblur="fnValidateGSTIN(this)"> 
							</div>
						</div>  					
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="address">Customer Address</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<?php if(!empty($pi) && !empty($account)){
	  ...
	  <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<select class="contactPerson form-control" name="contact_id" data-id="contacts" data-key="id" data-fieldname="first_name" width="100%" id="contact_id" data-where="save_status = 1 AND account_id = <?php echo $pi->account_id ;?>">							
									<option value="">Select Option</option>
									<?php 
										if(!empty($pi)){
											$contact_id = $pi->contact_id;
											if($contact_id != 0){
											$contact = getNameById('contacts',$pi->contact_id,'id');
						...
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="contact_phone_no" name="contact_phone_no"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($pi) && !empty($contact)) echo $contact->phone; ?>" readonly>
							</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="party_ref">Party Reference </label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="party_ref" name="party_ref"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($pi)) echo $pi->party_ref; ?>">
							</div>
						</div>
	  </div>
 </div>
				...
				<?php if(empty($pi)){ ?>
					...
					<div class="well scend-tr mobile-view"   id="chkIndex_1">
						...
						<div class="col-md-2 col-sm-12 col-xs-12 item form-group">	
							...
							<?php /*<select class="form-control selectAjaxOption select2 materialNameId Add_mat_onthe_spot" required="required" name="product[]" data-id="material" data-key="id" data-fieldname="material_name" data-where="created_by_cid = <?php echo $_SESSION['loggedInUser']->c_id; ?> AND status = 1" width="100%" onchange="getTax(event,this)" id="material">*/?>
			...
			<div>
				<div class="item form-group col-md-6 col-sm-12 col-xs-12 vertical-border">					
					...
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<!--<input type="text" class="form-control discount_offered" name="advance_received" id="advance_received" value="/* if(!empty($pi)) echo $pi->advance_received; */">-->
							<input type="text" class="form-control discount_offered" name="advance_received" id="advance_received" value="<?php if(!empty($pi)) echo $pi->advance_received; ?>" placeholder="Advance received in Rs">
						</div>
					</div> 
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="city">Other taxes</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="number" class="form-control" name="agt" id="agt" value="<?php  if(!empty($pi)) echo $pi->agt; ?>"  placeholder="Other taxes in Rs" onchange="keyupFunction(event,this)" onkeyup="keyupFunction(event,this)">
						</div>
					</div> 
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="label_printing_express">Other Expenses </label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control" name="label_printing_express" id="label_printing_express" value="<?php if(!empty($pi)) echo $pi->label_printing_express; ?>">
						</div>
					</div>
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="freight">Freight</label>
						<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
							FOR price:<input type="radio" class="flat" name="freight" id="genderM" value="FOR price" <?php if(!empty($pi) && $pi->freight == 'FOR price') echo 'checked'; else echo 'checked'; ?>  /> 
							To be paid by customer:<input type="radio" class="flat" name="freight" id="genderF" value="To be paid by customer" <?php if(!empty($pi) && $pi->freight == 'To be paid by customer') echo 'checked'; ?>/>
						</div>
					</div>
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="freight">Payment Terms</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
						<input type="text" class="form-control" name="payment_terms" id="payment_terms" value="<?php if(!empty($pi)) echo $pi->payment_terms; ?>">
							<?php /*<select class="form-control payment_terms" name="payment_terms" id="payment_terms">
								<?php 
									$paymentTerms = paymentTerms();
										foreach($paymentTerms as $paymentTerm){ 
									$paymentTermSelect = '';
									if(!empty($pi) && $pi->payment_terms == $paymentTerm){
							...
							<div class="checkbox">				
								<?php 					
									...
									foreach($discountOffered as $do){ ?>
										<label><input type="checkbox" class="flat" value="<?php echo $do ;?>" name="discount_offered[]" 
										
										<?php if (!empty($pi)  && ($pi->discount_offered != 'null' ) && ($pi->discount_offered != '' )){							
											if(in_array($do,json_decode($pi->discount_offered), TRUE)){
												echo "checked";
												}  	
										}?>	><?php echo $do;?></label>
									<?php }
					...
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control" name="brand_label" id="brand_label" value="<?php if(!empty($pi)) echo $pi->brand_label; ?>">
						</div>
					</div>
				</div>	
				<div class="item form-group col-md-6 col-sm-12 col-xs-12 vertical-border">
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="checkbox" name="dispatch_documents">
							<?php 	
								//if(!empty($pi->dispatch_documents)){
								...
								foreach($documentSubmitedWithDispatch as $dswd){
									...
									<?php 
									if(!empty($pi->dispatch_documents)){
									if (!empty($pi)  && ($pi->dispatch_documents != 'null' )){							
									
										if(in_array($dswd,json_decode($pi->dispatch_documents), TRUE)){
											echo "checked";
											}  	
									}
									}
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<input type="text" class="form-control" name="product_application" id="product_application" value="<?php if(!empty($pi)) echo $pi->product_application; ?>">
					</div>
				</div>   
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
					<label class="col-md-3 col-sm-12 col-xs-12" for="gaurantee">Guarantee/ Returnable Special Notes</label>
					<div class="col-md-6 col-sm-12 col-xs-12">
						<textarea id="gaurantee" rows="6" name="guarantee" class="form-control col-md-7 col-xs-12"><?php if(!empty($pi)) echo $pi->guarantee; ?></textarea>
					</div>
				</div>
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
