...
?>
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/savequot_to_pi" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
	...
	<div class="col-md-6 col-sm-12 col-xs-12 item form-group vertical-border">													
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<input type="text" class="form-control has-feedback-left datePicker" name="order_date" id="order_date" value="<?php if(!empty($piCreate) && $piCreate->order_date!=''){ echo $piCreate->order_date; }else {echo date("d-m-Y");}?>" required="required">
	  ...
	  <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="party_ref" name="party_ref"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($piCreate)) echo $piCreate->party_ref; ?>">
							</div>
						</div>
	  </div>
 </div>
	...
	<div class="panel">
			<div class="">
				...
				<?php if(empty($piCreate)){ ?>
					...
					<?php } else{ 
						$products = json_decode($piCreate->product);
						?>
						<div class="col-sm-12  col-md-12 label-box mobile-view2">
								   <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label>Material Name<span class="required">*</span></label></div>
								   <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label>Description</label></div>
						...
						if(!empty($products)){ 
								...
								?>
									<div class="well <?php if($i==1){ echo 'edit-row1 scend-tr mobile-view';}else{ echo 'scend-tr mobile-view';}?>"  id="chkWell_<?php echo $i; ?>" style="overflow:auto; ">
										...
										<div class="col-md-1 col-sm-6 col-xs-12 form-group">
										    <label>UOM</label>
											<input type="text" name="uom[]"  placeholder="uom" class="form-control col-md-7 col-xs-12" class="uom" value="<?php 
											 ...
											 <input type="hidden" name="uom[]" readonly value="<?php  echo $material->uom ;?>">
										</div>
										<div class="col-md-1 col-sm-6 col-xs-12 form-group">
										     <label>Price</label>
						...
						<div class="col-md-7 col-sm-5 col-xs-6 text-right">
						  <input type="hidden"  name="total" required="required" class="form-control col-md-7 col-xs-12"  value="<?php if(!empty($piCreate)) echo $piCreate->total; ?>"> 
							...
							<div class="col-md-5 col-sm-5 col-xs-6 text-left">
							      <span class="fa fa-rupee divSubTotal"><?php if(!empty($piCreate)){ echo $piCreate->total ; } else{ echo 0; }?></span>
							</div>
							 
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 text-right grand-tota2" >
						<div class="col-md-7 col-sm-5 col-xs-6 text-right form-group">
						  <input type="hidden"  name="grandTotal" required="required" class="form-control col-md-7 col-xs-12"  value="<?php if(!empty($piCreate)) echo $piCreate->grandTotal; ?>"> 
							<strong>Grand Total:</strong>&nbsp;
							</div>
							<div class="col-md-5 col-sm-5 col-xs-6 text-left form-group">
							     <span class="fa fa-rupee divTotal"><?php if(!empty($piCreate)){ echo $piCreate->grandTotal ; } else{ echo 0; }?></span>
							</div>
		...
		<div class=" ">
			<div>
				<div class="item form-group col-md-6 col-sm-12 col-xs-12 vertical-border">					
					...
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" class="form-control discount_offered" name="advance_received" id="advance_received" value="<?php if(!empty($piCreate)) echo $piCreate->advance_received; ?>" placeholder="Advance received in Rs">
						</div>
					</div> 
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="city">Other taxes</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="number" class="form-control" name="agt" id="agt" value="<?php  if(!empty($piCreate)) echo $piCreate->agt; ?>"  placeholder="Other taxes in Rs" onchange="keyupFunction(event,this)" onkeyup="keyupFunction(event,this)">
						</div>
					</div> 
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="label_printing_express">Other Expenses </label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control" name="label_printing_express" id="label_printing_express" value="<?php if(!empty($piCreate)) echo $piCreate->label_printing_express; ?>">
						</div>
					</div>
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="freight">Freight</label>
						<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
							FOR price:<input type="radio" class="flat" name="freight" id="genderM" value="FOR price" <?php if(!empty($piCreate) && $piCreate->freight == 'FOR price') echo 'checked'; else echo 'checked'; ?>  /> 
							To be paid by customer:<input type="radio" class="flat" name="freight" id="genderF" value="To be paid by customer" <?php if(!empty($piCreate) && $piCreate->freight == 'To be paid by customer') echo 'checked'; ?>/>
						</div>
					</div>
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="freight">Payment Terms</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
						<input type="text" class="form-control" name="payment_terms" id="payment_terms" value="<?php if(!empty($piCreate)) echo $piCreate->payment_terms; ?>">
							...
							<div class="checkbox">				
								<?php 					
									...
									foreach($discountOffered as $do){ ?>
										...
										<?php if (!empty($piCreate)  && ($piCreate->discount_offered != 'null' ) && ($piCreate->discount_offered != '' )){							
											if(in_array($do,json_decode($piCreate->discount_offered), TRUE)){
												echo "checked";
												}  	
										}?>	><?php echo $do;?></label>
									<?php }
					...
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control" name="brand_label" id="brand_label" value="<?php if(!empty($piCreate)) echo $piCreate->brand_label; ?>">
						</div>
					</div>
				</div>	
				<div class="item form-group col-md-6 col-sm-12 col-xs-12 vertical-border">
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<input type="text" class="form-control" name="product_application" id="product_application" value="<?php if(!empty($piCreate)) echo $piCreate->product_application; ?>">
					</div>
				</div>   
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
					<label class="col-md-3 col-sm-12 col-xs-12" for="gaurantee">Guarantee/ Returnable Special Notes</label>
					<div class="col-md-6 col-sm-12 col-xs-12">
						<textarea id="gaurantee" rows="6" name="guarantee" class="form-control col-md-7 col-xs-12"><?php if(!empty($piCreate)) echo $piCreate->guarantee; ?></textarea>
					</div>
				</div>
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="item form-group col-md-12 col-sm-12 col-xs-12 ">
				    <label class="col-md-3 col-sm-12 col-xs-12" for="certificate"></label>
				     <?php if(!empty($attachments)){?>
						<div class="col-md-6 col-md-offset-2 outline">
