...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal status-1 cls_display_none">
...
<div class="tab-content tab-to-mrgn">
									...
									<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-md-6 col-sm-12 col-xs-12">
											<?php if((!empty($sale_order))){ echo $sale_order->so_order;} else { echo $soCode; } ?>
										</div>
									</div>
									<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<label class="col-md-3 col-sm-12 col-xs-12" for="textarea">Order Date<span class="required">*</span></label>
										<div class="col-md-6 col-sm-12 col-xs-12">
											<?php if($sale_order->order_date!=''){ echo $sale_order->order_date; }else {echo date("d-m-Y");}?>
										</div>
									</div>
									<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<label class="col-md-3 col-sm-12 col-xs-12" for="freight">Type</label>
													<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
														Part Load:<input type="radio" class="flat calcDiscount" name="load_type" id="genderM" value="part_load" <?php if(!empty($sale_order->load_type) && $sale_order->load_type == "part_load"){ echo "checked=checked"; } ?> disabled>
														Full Load:<input type="radio" class="flat calcDiscount" name="load_type" id="genderF" value="full_load" <?php if(!empty($sale_order->load_type) && $sale_order->load_type == "full_load"){ echo "checked=checked"; } ?> disabled>
														None:<input type="radio" class="flat calcDiscount" name="load_type" id="genderF" value="none" <?php if(!empty($sale_order->load_type) && $sale_order->load_type == "none"){ echo "checked=checked"; } ?> disabled>
													</div>
												</div>
									</div>
 ...
 <div id="Customer-Details" class="container tab-pane ">
	  ...
	  <div class="item form-group">
			<label class="col-md-3 col-sm-12 col-xs-12" for="Addresses">Choose Address<!-- <span class="required">*</span> --></label>
								<div class="col-md-6 col-sm-12 col-xs-12">
								   <select name="party_state_id" id="c_address" class=" form-control c_address121" disabled>
						...
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						 ...
						 <div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<?php if(!empty($sale_order) && !empty($account)) echo $billing_gstin_1; ?>
							</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="email">Email</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($sale_order) && !empty($account)) echo $account->email; ?>
							</div>
						</div>
	  ...
	  <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<?php if(!empty($sale_order) && !empty($account)) echo $account->phone; ?>
							</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="contact_person">Contact Person</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<?php if(!empty($sale_order) && !empty($account)) echo $account->contact_name; ?>
								</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="contact_phone_no">Contact No.</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<?php if(!empty($sale_order)) echo $billing_phone_addrs; ?>
							</div>
						</div>
								...
								?>
									<div class="well <?php if($i==1){ echo 'edit-row1 scend-tr mobile-view';}else{ echo 'scend-tr mobile-view';}?>"  id="chkWell_<?php echo $i; ?>" style="overflow:auto; ">
										...
										<div class="col-md-1 col-sm-12 col-xs-12 item form-group">
											...
											<div class="form-control" readonly="readonly"><?php echo $product->description ; ?></div>
										</div>
										<div class="col-md-1 col-sm-6 col-xs-12 form-group">
										    <label>Quantity</label>
											<div class="form-control" readonly="readonly"><?php echo $product->quantity ;?>
											</div>
										</div>
										<div class="col-md-1 col-sm-6 col-xs-12 form-group">
										    <label>UOM</label>
											<div class="form-control" readonly="readonly"><?php
										...
										<div class="col-md-1 col-sm-6 col-xs-12 form-group">
										    <label>GST</label>
											<div class="form-control" readonly="readonly">
												<?php echo chop($product->gst,"%") ;?>
											</div>
										</div>
										<div class="col-md-2 col-sm-6 col-xs-12 form-group">
										    <label>Total</label>
											<div class="form-control" readonly="readonly"><?php echo $product->individualTotal ;?>
											</div>
										</div>
		...
		<div class=" ">
			<div>
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($discount_rate)) { echo $discount_rate; }else{ echo 0;} ?>
						</div>
					</div>
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="discount_offered">CBF</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($total_cbf_set)) { echo $total_cbf_set; } ?>
						</div>
					</div>
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="discount_offered">Weight</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($total_weight_set)) { echo $total_weight_set; } ?>
						</div>
					</div>
					...
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="checkbox pi_paymode_list">
								...
								?>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Cash" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Cash', $sale_order_paymode)){ echo "checked";} ?> disabled>Cash</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Debit Card" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) &&  in_array('Debit Card', $sale_order_paymode)){ echo "checked";} ?> disabled>Debit Card</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Credit Card" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) &&  in_array('Credit Card', $sale_order_paymode)){ echo "checked";} ?> disabled>Credit Card</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Cheque" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) &&  in_array('Cheque', $sale_order_paymode)){ echo "checked";} ?> disabled>Cheque</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Online Transfer" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) &&  in_array('Online Transfer', $sale_order_paymode)){ echo "checked";} ?> disabled>Online Transfer</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Credit" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) &&  in_array('Credit', $sale_order_paymode)){ echo "checked";} ?> disabled>Credit</label>
						</div>
						</div>
					</div>
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="permitted_by" style="display:none";>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($sale_order)) { echo $sale_order->pi_permitted; }  ?>
						</div>
					</div>  
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="city">Advance Payment</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($sale_order)) echo $sale_order->advance_received; ?>
						</div>
					</div>
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
						 <?php if(!empty($sale_order)) { echo $sale_order->special_discount; } else { echo '0'; }  ?>
				...
				<div class="form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
							ActualBasis:<input type="radio" class="flat" name="freight" id="genderM" value="FOR price" <?php if(!empty($sale_order) && $sale_order->freight == 'FOR price') echo 'checked'; else echo 'checked'; ?>  disabled/>
							Fixed Amount:<input type="radio" class="flat" name="freight" id="genderF" value="To be paid by customer" <?php if(!empty($sale_order) && $sale_order->freight == 'To be paid by customer') echo 'checked'; ?> disabled/>
						</div>
					</div>
				  <div class="col-md-12 col-sm-12 col-xs-12 item form-group" id="freight1">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
					 <?php  if (!empty($sale_order->freightCharges)) {	echo $sale_order->freightCharges;	} ?>
					</div> 
				  </div>
					<div class="col-md-12 col-sm-12 col-xs-12 item form-group">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<?php if(!empty($sale_order) && $sale_order->dispatch_date!=''){ echo $sale_order->dispatch_date; }else {echo date("d-m-Y");}?>
						</div>
					</div>
...
<!--------------Quick add customer code original----------------------->
				   ...
				   <ul class="laserAddress space">
					  ...
					  <li>
						 <div class="row">
							...
							<div class="col-md-7 text-right  addColenAfter"><span class="blueColor text-nowrap divSpecialDiscount"><?php if(!empty($spd_value)){ echo $spd_value;}
							?></span></div>
						 </div>
					  </li>
					  <li>
					  ...
					  <li>
						 <div class="row">
							...
							<div class="col-md-7 text-right  addColenAfter"><span class="blueColor text-nowrap divGrandTotal"><?php if(!empty($grand_total)){ echo $grand_total; } ?></span></div>
						 </div>
					  </li>
					  <li>
						 <div class="row">
	...
	<center>
			...
			<button class="btn edit-end-btn hidden-print cls_display_none"  id="btnPrint"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
