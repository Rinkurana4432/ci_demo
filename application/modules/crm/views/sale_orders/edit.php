...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right" style="margin: 10px 0;">
	<?php  if(!empty($sale_order) && $sale_order->save_status == 1) { echo '<a href="'.base_url().'crm/create_pdf/'.$sale_order->id.'"><button class="btn edit-end-btn btn-sm">Generate PDF</button></a>'; } ?>
</div>
*/ ?>
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveSaleOrder" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
	...
	<input type="hidden" name="revised_so_code" value="<?php  echo $revisedSOCode;  ?>" class="revised_po_code">
					...
					<div class="tab-content tab-to-mrgn">
						<div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
							<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
									<input id="Purchase_code" class="form-control col-md-7 col-xs-12" name="so_order" type="text" value="<?php if((!empty($sale_order))){ echo $sale_order->so_order;} else { echo $soCode; } ?>" readonly>
								</div>
							</div>
							<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="textarea">Order Date<span class="required">*</span></label>
								<div class="col-md-6 col-sm-12 col-xs-12">
									<input type="text" class="form-control has-feedback-left datePicker" name="order_date" id="order_date" value="<?php if(!empty($sale_order) && $sale_order->order_date!=''){ echo $sale_order->order_date; }else {echo date("d-m-Y");}?>" required="required" readonly>
						...
						<div class=" item form-group form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
								...
								None:<input type="radio" class="flat calcDiscount noneradio" name="load_type" id="checknone" value="none" <?php if(!empty($sale_order->load_type) && $sale_order->load_type == "none"){ echo "checked=checked"; } ?>>
			...
			<label class="col-md-3 col-sm-12 col-xs-12" for="Addresses">Choose Address<!-- <span class="required">*</span> --></label>
						...
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						 ...
						 <div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="gstin" name="gstin" class="form-control col-md-7 col-xs-12 gstin" value="<?php if(!empty($sale_order) && !empty($account)) echo $billing_gstin_1; ?>" onblur="fnValidateGSTIN(this)">
							</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="email">Email</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="email" id="email" name="email" class="form-control col-md-7 col-xs-12" placeholder="abcd@gmail.com" value="<?php if(!empty($sale_order) && !empty($account)) echo $account->email; ?>">
							</div>
						</div>
...
?>
	  <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	        <div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="tel" id="phone_no" name="phone_no"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($sale_order) && !empty($account)) echo $account->phone; ?>" readonly>
							</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="contact_person">Contact Person</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="contact_name" name="contact_id" class="form-control col-md-7 col-xs-12" value="<?php if(!empty($sale_order) && !empty($account)) echo $account->contact_name; ?>">
								</div>
						</div>
						<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-3 col-sm-12 col-xs-12" for="contact_phone_no">Contact No.</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="contact_phone_no" name="contact_phone_no"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($sale_order)) echo @$billing_phone_addrs; ?>" readonly>
							</div>
						</div>
     ...
     <!-- <div class="item form-group col-md-6 col-sm-12 col-xs-12 vertical-border">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<select class="form-control selectAjaxOption select2 select2-hidden-accessible material_type_id select2 add_material_cls materialTypeId requrid_class" required="required" id="material_type_id" name="material_type_id" id="" data-id="material_type" data-key="id" data-fieldname="name" data-where="created_by_cid=<?php echo $this->companyGroupId; ?> OR created_by_cid=0" tabindex="-1" aria-hidden="true" onchange="getMaterialName(event,this)" id="material_type">
				<option value="">Select Option</option>
				<?php
				if(!empty($sale_order) && $sale_order->material_type_id!=0){
					...
					<div class="well scend-tr mobile-view"   id="chkIndex_1">
                       <div class="col-md-2 col-sm-12 col-xs-12 item form-group">
						...
						<label class="col-md-12">UOM</label>
							...
							<input type="hidden" name="uom[]" class="uomid" value="" readonly>   
						</div>
						<div class="col-md-1 col-sm-6 col-xs-12 form-group">
		...
		<div class=" ">
			<div>
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input id="discount_rate" class="form-control col-md-7 col-xs-12" name="discount_rate" type="text" value="<?php echo !empty($sale_order->discount_rate)?$sale_order->discount_rate:0; ?>" readonly="">						</div>
					</div>
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="discount_offered">CBF</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input id="pi_cbf" class="form-control col-md-7 col-xs-12" name="pi_cbf" type="text" value="<?php /*echo !empty($total_cbf_set)?$total_cbf_set:'';*/ if(!empty($sale_order)) { echo $sale_order->pi_cbf; } else { echo '0'; }  ?>" readonly="">
						</div>
					</div>
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="discount_offered">Weight</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input id="pi_weight" class="form-control col-md-7 col-xs-12" name="pi_weight" type="text" value="<?php /* echo !empty($total_weight_set)?$total_weight_set:''; */ if(!empty($sale_order)) { echo $sale_order->pi_weight; } else { echo '0'; }  ?>" readonly="">
						</div>
					</div>
					...
					<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="checkbox pi_paymode_list">
								<?php
								if(!empty($sale_order)) {
								 $sale_order_paymode = json_decode($sale_order->pi_paymode, true); 
								}
								?>
								<!-- 08-03-2022 Start Resolve issue -->
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Cash" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Cash', $sale_order_paymode,)){ echo "checked";}else{ echo ''; } ?>>Cash</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Debit Card" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Debit Card', $sale_order_paymode)){ echo "checked";}else{ echo ''; } ?>>Debit Card</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Credit Card" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Credit Card', $sale_order_paymode)){ echo "checked";}else{ echo ''; } ?>>Credit Card</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Cheque" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Cheque', $sale_order_paymode)){ echo "checked";}else{ echo ''; } ?>>Cheque</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Online Transfer" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Online Transfer', $sale_order_paymode)){ echo "checked";}else{ echo ''; } ?>>Online Transfer</label>
							<label><input onchange="showPermittedBy();" type="checkbox" class="flat" value="Credit" name="pi_paymode[]" <?php if(!empty($sale_order_paymode) && in_array('Credit', $sale_order_paymode)){ echo "checked";}else{ echo ''; } ?>>Credit</label>
					...
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="remarks_by" style="display:none;">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control discount_offered" name="pi_remarks" value="<?php if(!empty($sale_order)) { echo $sale_order->pi_remarks; }  ?>" placeholder="Remark">
						</div>
					</div> 
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="permitted_by" style="display:none";>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control discount_offered" name="pi_permitted" id="advance_received" value="<?php if(!empty($sale_order)) { echo $sale_order->pi_permitted; }  ?>" placeholder="Permitted By">
						</div>
					</div>  
					<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-3 col-sm-12 col-xs-12" for="city">Advance Payment</label>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input onkeyup="AdvancePayment(event,this)" type="text" class="form-control discount_offered" name="advance_received" id="advance_received" value="<?php if(!empty($sale_order)) {echo $sale_order->advance_received;}else{echo 0;} ?>" placeholder="Advance received in Rs">
						</div>
					</div>
				...
				<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
						<input onkeyup="SpecialDiscount(event,this)" type="text" class="form-control special_discount" name="special_discount" id="special_discount" value="<?php if(!empty($sale_order)) { echo $sale_order->special_discount; } else { echo '0'; }  ?>">
					...
					<div class="item form-group col-md-12 col-sm-12 col-xs-12" id="sda_by" style="display:none;">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
						<input  type="text" class="form-control special_discount" name="special_discount_authorized" id="sda_by_discount" value="<?php if(!empty($sale_order)) { echo $sale_order->special_discount_authorized; } else { echo ''; }  ?>">
				...
				<div class="form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12" style="top: 5px;">
							ActualBasis:<input type="radio" class="flat" name="freight" id="genderM" value="FOR price" <?php if(!empty($sale_order) && $sale_order->freight == 'FOR price') echo 'checked'; else echo 'checked'; ?>  />
							Fixed Amount:<input type="radio" class="flat" name="freight" id="genderF" value="To be paid by customer" <?php if(!empty($sale_order) && $sale_order->freight == 'To be paid by customer') echo 'checked'; ?>/>
						</div>
					</div>
				  <div class="col-md-12 col-sm-12 col-xs-12 item form-group" id="freight1">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
					  <input type="text" id="freight" name="freightCharges" class="form-control col-md-7 col-xs-12 key-up-event freight_charges" placeholder="Freight"  value="<?php  if (!empty($sale_order->freightCharges)) {	echo $sale_order->freightCharges;	} ?>"   min="0">
					</div> 
				  </div>
					<div class="col-md-12 col-sm-12 col-xs-12 item form-group">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<input type="text" class="form-control has-feedback-left " name="dispatch_date" value="<?php if(!empty($sale_order) && $sale_order->dispatch_date!=''){ echo $sale_order->dispatch_date; }else {echo date("d-m-Y");}?>" id="dispatch_date">
							<span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
							<span id="inputSuccess2Status3" class="sr-only">(success)</span>
						</div>
					</div>
	 ...
	 <div class="boxSec mb-3 mb-md-0 borderLable purchaseInfo col-md-4" style="float: right;">
				 					<?php  
									   ...
									   /* 08-03-2022 End Resolve issue  */
										...
										//pre($type_of_customer_data);
										/* 08-03-2022 Start Resolve issue  */
										// pre($sale_order);
										$calcDiscount_val = $sale_order->load_type;
										...
										// pre($type_of_customer_data->$calcDiscount_val);
				   ...
				   <ul class="laserAddress space">
					  ...
					  <li>
						 <div class="row">
							<div class="col-md-5 pr-0 text-nowrap">Discount value <span  class="disRate"><?php if (!empty($sale_order->discount_rate)){echo '( '.$sale_order->discount_rate.' )';}else{echo '(0)';}; ?></span>:-</div>
