...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveLead_to_so" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
		...
		<div class="item form-group col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<select class="customerName selectAjaxOption select2" name="account_id" data-id="account" data-key="id" data-fieldname="name" data-where="account_owner = <?php echo $this->companyGroupId; ?> AND save_status = 1" width="100%" id="account_id" required="required">
									...
									<?php 
										if(!empty($sale_order)){
											$account = getNameById('account',$sale_order->existing_customer,'id');
 ...
 <div id="Customer-Details" class="container tab-pane ">
	        ...
	        <!--<div class="item form-group col-md-12 col-sm-12 col-xs-12">
						...
						<div class="item form-group ">
							...
							?>
								...
								<textarea id="address" rows="6" name="address" class="form-control col-md-7 col-xs-12" placeholder=""></textarea>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="gstin" name="gstin" class="form-control col-md-7 col-xs-12" value=""> 
							</div>
						</div>  
      ...
      <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
	     <div class="item form-group">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="email" id="email" name="email" class="form-control col-md-7 col-xs-12" placeholder="abcd@gmail.com" value=""> 
							</div>
						</div> 
	      <div class="item form-group">
							<label class="col-md-3 col-sm-12 col-xs-12" for="email">Phone No.</label>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="tel" id="phone_no" name="phone_no"  class="form-control col-md-7 col-xs-12" value="">
							</div>
						</div>						
						<div class="item form-group ">
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<input type="text" id="contact_phone_no" name="contact_phone_no"  class="form-control col-md-7 col-xs-12" value="">
							</div>
						</div>
						<div class="item form-group ">
	...
	<div >
			<div class="">
				...
				<?php if(empty($sale_order)){ ?>
					...
					<?php } else{ 
					$products = json_decode($sale_order->product_detail);
					if(!empty($products)){ 
						$i =  1;
						?>
						 <div class="col-sm-12  col-md-12 label-box mobile-view2">
						...
						?>
							<div class="well <?php if($i==1){ echo 'edit-row1 scend-tr mobile-view';}else{ echo 'scend-tr mobile-view';}?>"  id="chkIndex_<?php echo $i; ?>" style="overflow:auto;  text-align: center;">
								<div class="item col-md-2 col-sm-12 col-xs-12 form-group">
									<label >	Material Name	</label>
									<select class="form-control selectAjaxOption select2 materialNameId Add_mat_onthe_spot" required="required" name="product[]" data-id="material" data-key="id" data-fieldname="material_name" data-where="created_by_cid = <?php echo $this->companyGroupId; ?>" width="100%" onchange="getTax(event,this)" id="material">
										<option value="">Select Option</option>
										<?php 
											if(!empty($product)){
								...
								<div class="col-md-1 col-sm-6 col-xs-12 form-group">
								<label>	Price	</label>
									<input type="text" name="price[]"  placeholder="Price" class="form-control col-md-7 col-xs-12 price" value="<?php if(!empty($product) && isset($product->price)) echo $product->price;?>" onkeyup="keyupFunction(event,this)" onchange="keyupFunction(event,this)">
								</div>
								<div class="col-md-1 col-sm-6 col-xs-12 form-group">
								<label>	GST	</label>
						...
						<div class="col-md-7 col-sm-5 col-xs-6 text-right form-group">
						  <input type="hidden"  name="grandTotal" required="required" class="form-control col-md-7 col-xs-12"  value="<?php if(!empty($leads)) echo $leads->grand_total; ?>"> 
							...
							<div class="col-md-5 col-sm-5 col-xs-6 text-left form-group">
							     <span class="fa fa-rupee divTotal"><?php if(!empty($leads)){ echo $leads->grand_total ; } else{ echo 0; }?></span>
							</div>
...
<h3 class="Material-head">Dispatch Details<hr></h3>
	   <div class="col-md-6 col-sm-12 col-xs-12 vertical-border">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 item form-group">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<input type="number" class="form-control has-feedback-left" name="agt" id="agt" value="" onchange="keyupFunction(event,this)" onkeyup="keyupFunction(event,this)">
			</div>
		</div>
		<div class="col-md-12 col-sm-12 col-xs-12 item form-group">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 item form-group">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<input type="text" class="form-control has-feedback-left discount_offered" name="advance_received" id="advance_received" value="">
			</div>
		</div>					
		...
		<div class="item form-group col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<input type="text" class="form-control has-feedback-left" name="label_printing_express" id="label_printing_express" value="">
			</div>
		</div>				   
...
<div class="col-md-6 col-sm-12 col-xs-12 vertical-border">	
       <div class="item form-group col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<input type="text" class="form-control has-feedback-left" name="brand_label" id="brand_label" value="">
			</div>
		</div>	
		...
		<div class="item form-group col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<input type="text" class="form-control has-feedback-left" name="product_application" id="product_application" value="">
			</div>
		</div>   
		<div class="item form-group col-md-12 col-sm-12 col-xs-12">
