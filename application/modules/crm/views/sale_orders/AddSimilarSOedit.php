...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveSimilarSO" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
	...
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<input id="Purchase_code" class="form-control col-md-7 col-xs-12" name="soCode" type="text" value="<?php echo $soCode; ?>" readonly>
		</div>
	</div>
	</div>
...
<!-- Similar Sale order Start 10-03-2022 -->
...
<!-- Similar Sale order End 10-03-2022 -->
