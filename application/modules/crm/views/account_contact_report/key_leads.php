  ...
  <div class="col-md-12 col-xs-12 for-mobile">
        <div class="Filter Filter-btn2">
          <div class="col-md-4 datePick-right">
              ...
              <form action="<?php echo base_url(); ?>crm/key_accounts" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div"> 
         <div class="btn-group" role="group" aria-label="Basic example">
          <a href="<?php echo base_url(); ?>crm/key_accounts" class="Reset-btn btn btn-success">
        Reset
         </a>
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/key_accounts" method="get" id="export-form">
     ...
     <div id="print_div_content">
      <table id="attendance123" class="table table-striped table-bordered account_index" cellspacing="0" width="100%">
         <thead>
            ...
            <tbody>
             <?php if(!empty($key_leads)){
                           $i = 1;
                            $primaryContact = array();
                           foreach($key_leads as $todaysleads){
                              ...
                              if(!empty($todaysleads) && $todaysleads['lead_source'] !='' && $todaysleads['lead_source'] != 0) {  
                                $lead_source = getNameById('lead_source',$todaysleads['lead_source'],'id');
            ...
            ?>
               <tr>
                  ...
                  <td><?php echo $todaysleads['created_date']; ?></td>
               </tr>
               <?php 
               $output[] = array(
                        ...
                        'Full Name' => !empty($leadname)?$leadname:'',
                        ...
                        'Created Date' => !empty($todaysleads['created_date'])?$todaysleads['created_date']:'',
                      );   
               ?>
             <?php  }       
                $data3  = $output;
