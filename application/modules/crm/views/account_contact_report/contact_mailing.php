...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/contact_mailing_report" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="btn-group" role="group" aria-label="Basic example">
          <a href="<?php echo base_url(); ?>crm/contact_mailing_report" class="Reset-btn btn btn-success">
            Reset
          </a>
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/contact_mailing_report" method="get" id="export-form">
            ...
            <?php if(!empty($contactsgrp)){
                           foreach($contactsgrp as $contactsgrps){
                             ...
                             $totalsum = 0;
                              ...
                              if(!empty($contactsgrps11) && $contactsgrps11['account_id'] !='' && $contactsgrps11['account_id'] != 0){
                                $aownername = getNameById('account',$contactsgrps11['account_id'],'id');
                              #  pre($ownername);
                                $aowner_name = !empty($aownername)?$aownername->name:''; 
                                $awner_phone = !empty($aownername)?$aownername->phone:'';
                              }else{ $aowner_name = '';  $awner_phone = '';}

                              if(!empty($contactsgrps11) && $contactsgrps11['mailing_city'] !='' && $contactsgrps11['mailing_city'] != 0){
                                $city = getNameById('city',$contactsgrps11['mailing_city'],'city_id');
                              #  pre($ownername);
                                $city_name = !empty($city)?$city->city_name:''; 
                              }else{ $city_name = '';}

                              if(!empty($contactsgrps11) && $contactsgrps11['mailing_state'] !='' && $contactsgrps11['mailing_state'] != 0){
                                $state = getNameById('state',$contactsgrps11['mailing_state'],'state_id');
                              #  pre($ownername);
                                $state_name = !empty($state)?$state->state_name:''; 
                              }else{ $state_name = '';}

                              if(!empty($contactsgrps11) && $contactsgrps11['mailing_country'] !='' && $contactsgrps11['mailing_country'] != 0){
                                $country = getNameById('country',$contactsgrps11['mailing_country'],'country_id');
                              #  pre($ownername);
                        ...
                        <td><?php echo $contactsgrps11['first_name'] . $contactsgrps11['last_name']; ?></td>
                        <td><?php echo $contactsgrps11['phone']; ?></td>
                        <td><?php echo $contactsgrps11['email']; ?></td>
                        <td><?php echo $contactsgrps11['mailing_street']; ?></td>
                        <td><?php echo $city_name; ?></td>
                        <td><?php echo $state_name; ?></td>
                        <td><?php echo $country_name; ?></td>
                        <td><?php echo $contactsgrps11['mailing_zipcode']; ?></td>
                    ...
                    <?php 
                      $output[] = array(
                        ...
                        'Full Name' => $contactsgrps11['first_name'] . $contactsgrps11['last_name'],
                        'Phone No.' => !empty($contactsgrps11['phone'])?$contactsgrps11['phone']:'',
                        'Email' => !empty($contactsgrps11['email'])?$contactsgrps11['email']:'',
                        'Mailing Street' => !empty($contactsgrps11['mailing_street'])?$contactsgrps11['mailing_street']:'',
                        ...
                        'Mailing Zip' => !empty($contactsgrps11['mailing_zipcode'])?$contactsgrps11['mailing_zipcode']:'',
