<div class="x_content">
   ...
   <div class="col-md-12 col-xs-12 for-mobile">
      <!--div class="Filter Filter-btn2">
         <form class="form-search" method="post" action="<?= base_url() ?>crm/add_industry">
            <div class="col-md-6">
               <div class="input-group">
                  <span class="input-group-addon">
                  <i class="ace-icon fa fa-check"></i>
                  </span>
                  <input type="text" class="form-control search-query" placeholder="Enter id,Company Name" name="search" id="search" value="<?php //if(!empty($_GET['search']))echo $_GET['search'];?>" data-ctrl="crm/add_industry">
         ...
         <form class="form-search" id="orderby" method="post" action="<?//= base_url() ?>crm/add_industry">
	   ...
	   <div class="row hidde_cls export_div">
		  <div class="col-md-12">
			 <div class="col-md-3 datePick-right">
				<button type="button" class="btn btn-success add_crm_tabs addBtn" data-toggle="modal" id="add" data-id="add_industry"><i class="fa fa-plus-circle valignmiddle btnTitle-icon"></i>Add</button>
				<a href="<?php echo base_url(); ?>crm/add_industry"><input type="button" name="submitSearchReset" class="btn btn-success" value="Reset"></a>
			 </div>
		  </div>
	   </div>
   </div>
   ...
   <div id="print_div_content">
      <!---------- datatable-buttons ------------->
      <table id="datatable-buttons1" class="table table-striped table-bordered account_index" style="width:100%;margin-top: 44px;" >
         <thead>
            <tr>
               <th scope="col">Id</th>
         ...
         <tbody>
            <?php if(!empty($industry_data)){
               ...
               $action = '';
               				...
               				$action .= '<a href="javascript:void(0)" id="'.$industrydata['id'].'" data-id="add_industry" data-tooltip="Edit" class="add_crm_tabs btn btn-edit  btn-xs"><i class="fa fa-pencil"></i>  </a>';	
               ...
               <td data-label='Industry Name:'>".$industrydata['industry_detl']."</td>
               <td data-label='Created by:'>".$crtd_by_name."</td>
               <td data-label='Created Date:'>".$industrydata['created_date']."</td>
               <td class='hidde' data-label='Action:'>".$action."</td>	
               </tr>";
               }
               } ?>
         </tbody>
