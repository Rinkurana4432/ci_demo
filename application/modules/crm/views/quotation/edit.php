...
<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveQuotation" enctype="multipart/form-data" id="leadForm" novalidate="novalidate">
...
<div class=" item form-group ">													
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			<input type="tel" id="phone_no" name="phone_no" required="required"  class="form-control col-md-7 col-xs-12" value="<?php if(!empty($quot) && !empty($account)) echo $account->phone; ?>">
		</div>						
	</div>
</div>
<hr>	
...
<hr>
	<div class="form-group">
		<div class="col-md-6 col-md-offset-3">
			...
			<?php if((!empty($quot) && $quot->save_status !=1) || empty($quot)){
