...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
	          <form class="form-search" method="get" action="<?= base_url() ?>crm/add_price_compt">
   <div class="col-md-6">
      <div class="input-group">
         <span class="input-group-addon">
         <i class="ace-icon fa fa-check"></i>
         </span>
         <input type="text" class="form-control search-query" placeholder="Enter id,Name" name="search" id="search" data-ctrl="crm/add_price_compt" value="<?php if(!empty($_GET['search']))echo $_GET['search'];?>">
         <span class="input-group-btn">
         <button type="submit" class="btn btn-purple btn-sm">
         <span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
         Search
         </button>
         <a href="<?php echo base_url(); ?>crm/add_price_compt"><input type="button" name="submitSearchReset" class="btn btn-outline-secondary" value="Reset"></a>
         </span>
      </div>
   </div>
</form>
 ...
 <div id="demo" class="collapse">
               ...
               <div class="control-group">
                  <div class="controls">
                     <div class="input-prepend input-group">
                        ...
                        <input type="text" style="width: 200px" name="tabbingFilters" id="tabbingFilters" class="form-control" value="" data-table="crm/add_price_compt">
                     </div>
                  </div>
               </div>
            </fieldset>
            <form action="<?php echo base_url(); ?>crm/add_price_compt" method="get" id="date_range">	
   ...
   <?php
      ...
      $this->companyGroupId = (isset($_SESSION['companyGroupSessionId']) && $_SESSION['companyGroupSessionId']!='' && $_SESSION['companyGroupSessionId'] != 0)?$_SESSION['companyGroupSessionId']:$_SESSION['loggedInUser']->c_id ;
       ?>
   <div class="stik">
      <form action="<?php echo site_url(); ?>crm/add_price_compt" method="get" id="export-form">
   ...
   <div class="row hidde_cls export_div">
      <div class="col-md-12">
         <input type="hidden" value='comp_price' id="table" data-msg="Competitor" data-path="crm/add_price_compt"/>
        
         <div class="btn-group"  role="group" aria-label="Basic example">
		    <?php 
               if($can_add) {
               	//echo '<a href="'.base_url().'crm/editAccount/"><button type="buttton" class="btn btn-info">Add</button></a>'; 
               	echo '<button type="button" class="btn btn-success add_crm_tabs addBtn" data-toggle="modal" id="add" data-id="add_price"><i class="fa fa-plus-circle valignmiddle btnTitle-icon"></i>Add</button>';
               } ?>
            ...
            <form action="<?php echo base_url(); ?>crm/add_price_compt" method="get" style="display:inline-block;">
   ...
   <div id="print_div_content">
      <!-------------datatable-buttons--------->          
      <form class="form-search" id="orderby" method="post" action="<?= base_url() ?>crm/add_price_compt">
      ...
      <table id="mytable" class="table tblData table-striped table-bordered" data-id="comp_price" style="width:100%; margin-top:40px;" border="1" cellpadding="3">
         <thead>
            <tr>
               <th>All<br><input id="selecctall" type="checkbox"></th>
               <th scope="col" class="col-sm-1">Id
                  <span><a href="<?php echo base_url(); ?>crm/add_price_compt?sort=asc" class="up"></a>
                  <a href="<?php echo base_url(); ?>crm/add_price_compt?sort=desc" class="down"></a></span>
               </th>
            ...
            <?php if(!empty($competitor_details)){
               foreach($competitor_details as $competitordetails){ 
                   ...
                   if($can_edit) { 
               		...
               		$action =  '<a href="javascript:void(0)" id="'. $competitordetails["id"] . '" data-id="add_price" class="add_crm_tabs btn btn-edit  btn-xs" data-tooltip="Edit" id="' . $competitordetails["id"] . '"><i class="fa fa-pencil"></i> </a>';
               	}	
               	#if($can_view) { 				
               	...
               	if($can_delete) { 
               		$action = $action.'<a href="javascript:void(0)" data-tooltip="Delete"  class="delete_listing btn btn-xs btn-delete" data-href="'.base_url().'crm/delete_add_price_compt/'.$competitordetails["id"].'"><i class="fa fa-trash"></i></a>';
               	}
               	...
               	$comptname = getNameById('competitor_details',$competitordetails['account_id'],'id');
				//pre($competitordetails);
               	if(!empty($comptname)){
               		$comptName1 = $comptname->name;
               		$phone1 = $comptname->phone;
               	}else{
               		$comptName1 = '';
               		$phone1 = "";
               	}
               ...
               <img class="img-responsive hidde" src="'.base_url(). 'assets/images/draft.png" > </a>';
                  echo "<td><input name='checkbox[]' class='checkbox1 checkbox[]' type='checkbox'  data-ai=".$competitordetails['id']." value=".$competitordetails['id'].">";
               						   		if($competitordetails['favourite_sts'] == '1'){
               						   				...
               						   				echo"<input type='hidden' value='comp_price' id='favr' data-msg='Competitor Details' data-path='crm/add_price_compt'  id-recd=".$competitordetails['id'].">";
               						   		}else{
               		...
               		<td data-label='Company Name:'>".$comptName1."</td>
               		<td data-label='Phone:'>".$phone1."</td>
