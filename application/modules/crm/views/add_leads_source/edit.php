<form method="post" class="form-horizontal" action="<?php echo base_url(); ?>crm/saveleadsourcename" enctype="multipart/form-data" id="myform" novalidate="novalidate">
			...
			<div class="col-md-6 col-sm-12 col-xs-12 processDiv middle-box">
				<div class="well " style="overflow:auto; overflow:auto;border-top: 1px solid #c1c1c1 !important;" id="chkIndex_1">				
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12 form-group">
					   <label style="border-right: 1px solid #c1c1c1 !important;">Lead's Source Name</label>
					<input type="text" id="processName" name="process_name[]" required="required" class="form-control col-md-12 col-xs-12" placeholder="Lead's Source Name" value="<?php if(!empty($customer_type)) echo $customer_type->leads_source_name; ?>" style="border-right: 1px solid #c1c1c1 !important;"></div>					
