...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/lead_by_industry" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="btn-group" role="group" aria-label="Basic example">
           <a href="<?php echo base_url(); ?>crm/lead_by_industry" class="Reset-btn btn btn-success">
        Reset
         </a>
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/lead_by_industry" method="get" id="export-form">
             ...
             # pre($lead_by_owner);
                           ...
                           $totalsum = 0;
                            foreach($leadsbyowner as $owner){
                              ...
                              if(!empty($owner) && $owner['lead_industry'] !='' && $owner['lead_industry'] != 0) {  
                                $lead_source = getNameById('add_industry',$owner['lead_industry'],'id');
                                $leadSource = !empty($lead_source)?$lead_source->industry_detl:''; 
                              }else { $leadSource = ''; }
                  ...
                  if($owner['contacts'] !=''){
                   ...
                   ?>
                    ...
                    <?php 
                      $output[] = array(
                        'Leads Industry' => !empty($leadSource)?$leadSource:'',
