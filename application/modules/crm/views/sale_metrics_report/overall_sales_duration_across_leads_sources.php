...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/overall_sales_duration_across_leads_sources" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/overall_sales_duration_across_leads_sources" method="get" id="export-form">
      ...
      <table id="attendance123" class="table table-striped table-bordered account_index" cellspacing="0" width="100%">
         <thead>
            <tr>
               ...
               <th>AVG OF SALE DURATION IN DAY(S)</th>
            </tr>
         </thead>
          <tbody>   
                    ...
                    <?php 
                      $output[] = array(
                       ...
                       date('M Y', strtotime("last month"))
                         => !empty($total)?$total:'',
                        'AVG OF SALE DURATION IN DAY(S)' => bcdiv($total / $yh, 1, 2),
                      );   
                    ?>
            <?php } ?>        
								    <?php }}
