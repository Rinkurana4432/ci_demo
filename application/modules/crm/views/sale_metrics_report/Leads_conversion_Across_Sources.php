...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/Leads_conversion_Across_Sources" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/Leads_conversion_Across_Sources" method="get" id="export-form">
