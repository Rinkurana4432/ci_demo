...
<div class="col-md-12 col-xs-12 for-mobile">
      <div class="Filter Filter-btn2">
        <div class="col-md-4 datePick-right">
            ...
            <form action="<?php echo base_url(); ?>crm/sale_cycle_deal_across_owners" method="get" id="date_range">
   ...
   <div class="stik">
      <div class="col-md-12 export_div">
         ...
         <div class="col-md-4 col-sm-12 datePick-right">
            <form action="<?php echo site_url(); ?>crm/sale_cycle_deal_across_owners" method="get" id="export-form">
                  ...
                  ?>
                    ...
                    <?php 
                      $output[] = array(
                        ...
                        date('M Y', strtotime("last month")) => !empty($total)?$total:'',
                        'AVG OF SALE CYCLE DURATION IN DAY(S)' => bcdiv($total / $yh, 1, 2),
                      );   
                    ?>
                    <?php } ?>        
								    <?php }
