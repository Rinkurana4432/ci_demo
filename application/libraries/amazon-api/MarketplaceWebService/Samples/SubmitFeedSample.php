 ...
 ***********************************************************************/
 ...
 //$service = new MarketplaceWebService_Model();
...
/********* End Comment Block *********/
//echo"<pre>";print_r($marketplaceIdArray);echo $marketplaceIdArray[id];die;
/********* Begin Comment Block *********/
...
//$request->setMarketplaceIdList('A21TJRUUN4KGV');
...
$request->setMWSAuthToken('amzn1.sellerapps.app.f6d0fda7-762e-4aef-829f-93ecdea2bfc5'); // Optional
