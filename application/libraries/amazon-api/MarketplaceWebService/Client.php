...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  public function getReport($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequest) {
      require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/GetReportRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequest($request);
    }
    require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/GetReportResponse.php');
  ...
  public function submitFeed($request)
  {
    ...
    require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/SubmitFeedResponse.php');
  ...
  public function requestReport($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_RequestReportRequest) {
      require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/RequestReportRequest.php');
      $request = new MarketplaceWebService_Model_RequestReportRequest($request);
    }
    require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/RequestReportResponse.php');
  ...
  public function getReportList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportListRequest) {
      require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/GetReportListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportListRequest($request);
    }
    require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/GetReportListResponse.php');
      ...
      do {
        try {
          ...
          switch ($httpStatus) {
          	...
          	case 500:
          	case 503:
				require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/ErrorResponse.php');
          ...
          require_once (APPPATH.'libraries/amazon-api/MarketplaceWebService/Exception.php');
  ...
  private function performRequest($action, array $converted, $dataHandle = null) {
    ...
    //$this->headerContents = @fopen('php://temp', 'rw+');
    ...
    require_once(APPPATH.'libraries/amazon-api/MarketplaceWebService/Model/ResponseHeaderMetadata.php');
