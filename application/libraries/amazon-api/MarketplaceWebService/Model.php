            ...
            if (is_array($fieldType)) {
                if ($this->isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
						require_once (APPPATH. "libraries/amazon-api/".str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php");
                ...
                if ($this->isComplexType($fieldType)) {
                    $elements = $xpath->query("./a:$fieldName", $dom);
                    if ($elements->length == 1) {
                        require_once (APPPATH. "libraries/amazon-api/".str_replace('_', DIRECTORY_SEPARATOR, $fieldType) . ".php");
						/* require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . $fieldType . ".php"); */
                    ...
                    $data = null;
                    if ($element->length == 1) {
						//print_r($this->fields[$fieldName]['FieldType']);die;
