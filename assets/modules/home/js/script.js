...
(function() {
    ...
    $('a', selectors.nav).on('mouseover click', function() {
        let $this = $(this)[0];
...
$(".btn-with-icon").on("mouseover click", function() {
		...
		$.ajax({
			...
			success: function (response) {
				if(response !=''){			
					...
					$('#subscribe_email_bx').val('');
					$('#sub_msg').html('Thank you for your Interest!');
				}
			}
		});
	}
...
/* --------------------- Recently Viewed Slider ----------------- */
	...
	/* --------------------- About Our pro Slider ----------------- */
	
	$(document).ready(function(){
	
    $('.about-ourproSlider').slick({
		slidesToShow: 4,
        slidesToScroll: 1,
        autoplay: true,
        autoplaySpeed: 1000,
...
$(document).on('mouseover','.link-menu',function(){
	$('.link-menu').siblings('.result').addClass("result_hover");
	$(this).siblings('.result').removeClass("result_hover");
})
...
var header = document.getElementById("fixedsearch");
