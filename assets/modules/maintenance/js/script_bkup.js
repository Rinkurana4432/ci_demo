...
function addMaterialDetail(){
	...
	var logged_user12 = $('#loggedUser').val();

	console.log("djsbnjasdbcn=>>>>",logged_user12);
	//var y = 1; 
...
function machineProcess(){
	...
	$(add_machine).click(function(e){ 
		...
		e.preventDefault();
			...
			k++;
			well++;
			//$(machine_detail).append('<div class="item form-group"><div class="well" id="chckIndex_'+x+'" data-id="frst_div_'+x+'"><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Process Type<span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><select class="form-control selectAjaxOption select2 select2-hidden-accessible processType_id select2" required="required" name="process_type[]" data-id="process_type" data-key="id" data-fieldname="process_type" tabindex="-1" aria-hidden="true" onchange="getProcess(event,this)"><option value="">Select Option</option></select></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Process Name<span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><select class="form-control selectAjaxOption select2 select2-hidden-accessible process_name_id" required="required" name="process_name[]" tabindex="-1" aria-hidden="true" required="required" onchange="getMachineName(event,this)"><option value=""></option></select></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Machine Name<span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><select class="form-control selectAjaxOption select2 select2-hidden-accessible machine_name_id" required="required" name="machine_name[]" tabindex="-1" aria-hidden="true" required="required"><option value="">Select Option</option></select></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Machine Parameter<span class="required">*</span></label><div class="col-md-3 col-sm-6 col-xs-12"><div class="col-md-6 col-sm-6 col-xs-12 form-group parameter_name"></div></div><div class="col-md-3 col-sm-6 col-xs-12"><div class="col-md-6 col-sm-6 col-xs-12 form-group uom"></div></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Production Shift<span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12 form-group"><input type="production" id="production" name="production_shift[]" class="form-control col-md-7 col-xs-12" placeholder="production per Shift"></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Workers<span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12 form-group"><input type="workers" id="workers" name="workers[]" class="form-control col-md-7 col-xs-12" placeholder="workers Needed"></div></div><div class="item form-group"><label class="control-label col-md-4 col-sm-3 col-xs-12" for="product detail">Dos & Donts<span class="required">*</span></label><div class="col-md-3 col-sm-6 col-xs-12 form-group"><textarea id="purpose"  name="dos[]" class="form-control col-md-1" placeholder="Dos"></textarea><br><br></div><div class="col-md-3 col-sm-6 col-xs-12 form-group"><textarea id="purpose"  name="donts[]" class="form-control col-md-1" placeholder="Donts"></textarea><br><br></div></div><button class="btn btn-danger remove_machine" type="button"><i class="fa fa-minus"></i></button></div></div>');
			
			console.log("weeee",well);
			
				$(machine_detail).append('<div class="well well2 scend-tr" id="chckIndex_'+well+'" data-id="frst_div_'+well+'"><div class="col-md-6 col-sm-12 col-xs-12 vertical-border"><div class="item form-group "><label class="col-md-3 col-sm-12 col-xs-12">Process Name<span class="required">*</span></label><div class=" form-group col-md-6 col-sm-12 col-xs-12"><select class="form-control selectAjaxOption select2 select2-hidden-accessible process_name_id" required="required" name="process_name[]" tabindex="-1" aria-hidden="true" required="required" onchange="getMachineName(event,this)" data-where="process_type_id='+processType+'" data-id="add_process" data-key="id"  data-fieldname = "process_name"><option value=""></option></select></div></div><div class="item form-group "><label class="col-md-3 col-sm-12 col-xs-12">Machine Name</label><div class="col-md-6 col-sm-12 col-xs-12 form-group"><select class="form-control selectAjaxOption select2 select2-hidden-accessible machine_name_id" required="required" name="machine_name[]" tabindex="-1" aria-hidden="true" required="required"><option value="">Select Option</option></select></div></div></div><div class="col-md-6 col-sm-12 col-xs-12 vertical-border"><div class="item form-group  "><label class="col-md-3 col-sm-12 col-xs-12">Shift</label><div class="col-md-6 col-sm-12 col-xs-12 form-group"><input type="production" id="production" name="production_shift[]" class="form-control col-md-7 col-xs-12" placeholder="production per Shift"></div></div><div class="item form-group "><label class="col-md-3 col-sm-12 col-xs-12">Workers</label><div class="col-md-6 col-sm-12 col-xs-12 form-group"><input type="workers" id="workers" name="workers[]" class="form-control col-md-7 col-xs-12" placeholder="workers"></div></div></div><div class="well col-container " style="display:table; clear:both;"><div class="item form-group col-md-3 col-xs-12"> <div class="col"><label>Machine Parameter</label></div><div class="col-md-4 col-sm-6 col-xs-4 form-group" style="border-right: 1px solid #c1c1c1;"><div class="col-md-12 col-sm-6 col-xs-12 form-group parameter_name"></div></div><div class="col-md-4 col-sm-6 col-xs-4 form-group" style="border-right: 1px solid #c1c1c1;"><div class="col-md-12 col-sm-6 col-xs-12 form-group uom"></div></div><div class="col-md-4 col-sm-6 col-xs-4 form-group"><div class="col-md-12 col-sm-6 col-xs-12 form-group value"></div></div></div><div class="item form-group  col-md-5 col-xs-12" ><div class="col" ><label>Dos & Donts</label></div><div class="col-md-6 col-sm-6 col-xs-6 form-group" style="border-right: 1px solid #c1c1c1;"><textarea id="purpose"  name="dos[]" class="form-control col-md-7 col-xs-12 textarea" placeholder="Dos" "'+style1+'"></textarea><br><br></div><div class="col-md-6 col-sm-6 col-xs-6 form-group"><textarea id="purpose"  name="donts[]" class="form-control col-md-7 col-xs-12 textarea" placeholder=" Donts" "'+style1+'"></textarea><br><br></div></div><div class="item form-group  col-md-2 col-xs-12" ><div class="col" ><label>Description</label></div><div class="col-md-12 col-sm-12 col-xs-12 form-group" ><textarea id="purpose"  class="form-control col-md-7 col-xs-12 textarea" placeholder="Description" name="description[]" "'+style1+'"></textarea><br><br></div></div><div class="item form-group  col-md-2 col-xs-12" ><div class="col" ><label>Attachment</label></div><input type="hidden" name="old_doc_'+well+'" value=""><div class="col-md-12 col-sm-12 col-xs-12 add_documents"><div class="col-md-10 col-sm-12 col-xs-10 form-group" id="abc_'+well+'"><input type="file" class="form-control col-md-7 col-xs-12" name="documentsAttach_frst_div_'+well+'[]" ></div><button class="btn edit-end-btn  add_moreDocs" style="margin-bottom: 3%;" type="button"><i class="fa fa-plus"></i></button></div><br><br></div></div><button class="btn btn-danger remove_machine" type="button"><i class="fa fa-minus"></i></button></div></div>');
...
function get_jobcard_on_select(){
	$('.party_code_cls').on('change',function(){
		...
		$.ajax({
			...
			data: {party_code_id:party_code_id}, 
			success: function(result){
				var dataObj = JSON.parse(result);
				console.log('dataObj===>>>',dataObj);
	...
	$('.date').on('change',function(){
		if(window.location.href  == site_url+'production/production_data'){
			...
			$('.btn_heading_hide').show();
				...
				data: {'selected_department_idd':selected_department_idd,'shift':shift, 'date':date,'table':'production_data'}, 
				...
				if(result1 == 'Data of this date and shift already exist'){
					...
					$('<div class="rTableRow mobile-view2"><div class="rTableHead"><label>Select</label></div><div class="rTableHead"><label>Machine Name</label></div><div class="rTableHead"><label>Sale order</label></div><div class="rTableHead"><label>Product Name</label></div><div class="rTableHead"><label>BOM Routing Product Name</label></div><div class="rTableHead"><label>NPDM</label></div><div class="rTableHead fix-width"><label>Workers</label></div>  <div class="rTableHead fix-width"><label>Hrs in Wages,% in per piece</label></div><div class="rTableHead"><label>Production Output</label></div><div class="rTableHead"><label>Labour costing</label></div><div class="rTableHead" ><label>Remarks</label></div><div class="rTableHead"></div></div>"').prependTo(".app_div");
	...
	$('#planningDate').on('change',function(){
		...
		setTimeout(function () {
			...
			$.ajax({
				...
				data: {selected_department_idd:selected_department_idd,'shift':shift, 'date':date,'table':'production_planning'}, 
				success: function(result1){
					if(result1 == 'Data of this date and shift already exist'){
					...
					$(".draftBtn").attr("disabled", true);
						...
						if(lenth != 0){
							$(".disablesubmitBtn").attr("disabled", false);
							$(' <div class="rTableRow mobile-view2"><div class="rTableHead"><label>Machine Name<span class="required">*</span></label></div><div class="rTableHead"><label>Party Specification</label></div><div class="rTableHead"><label>Sale order</label></div><div class="rTableHead"><label>Product Name</label></div><div class="rTableHead"><label>BOM Routing Product Name</label></div><div class="rTableHead"><label>NPDM</label></div><div class="rTableHead"><label>Worker</label></div><div class="rTableHead"><label>Output</label></div><div class="rTableHead" ><label></label></div></div>"').prependTo(".app_div_planing");
							var k = 0;
							for(var j=0; j<lenth; j++){
...
$(document).on("click",".validate",function(){ 
		...
		console.log('Job id===>>>>>',job_card_id);
			$.ajax({
			   ...
			   data: {id:job_card_id, approve:1, validated_by:loggedinUser }, 
			   success: function(result) {
				     if(result != '') {
...
$(document).on("click",".validateonselect",function(){ 
		...
		console.log('Job id===>>>>>',job_card_id);
			$.ajax({
			   ...
			   data: {id:checkValues, approve:1, validated_by:loggedinUser }, 
			   success: function(result) {
				     if(result != '') {
						 console.log("fff",result);
					//var obj = $.parseJSON(result);
...
$(document).on("click","#Add_worker_details_on_button_click",function(){
	...
	var error = 0;
		...
		$.ajax({
			   ...
			   data: {name:worker_name,mobile_number:mobile_number,salary:salary_amnt},
...
function getMessageDisplay(){
	...
	if(window.location.href == site_url+'production/production_planning'){
		...
		data: {selected_planning_date:getDate}, 
		success: function(response){
			if(response != ''){
		...
		if(($("#sale_order_complete").prop("checked") == true)){
			if(confirm('Are you sure!') == true) {						
				...
				$.ajax({
					...
					data: { id:sale_order_id, complete_status:1, completed_by:loggedInUserId }, 
					success: function(result) {
						if(result != '') {
							var obj = $.parseJSON(result);
						   if(obj.status == 'success') {					 
...
function getQtyValue(evt , t){
 ...
 function getMaterialIdFromWorkOrder(){
	...
	$.ajax({
		...
		data: {material_ids:selectedMaterialId}, 
		success: function(result) {
			var data = JSON.parse(result);
...
function getMaterialNamesaleorder(evt, t , selProcessType = '' , c_id = '' ){
...
function select2saleorder(material_type_id , logged_user){
		$('.productNameId').attr('data-where','id = '+material_type_id+' AND created_by_cid='+logged_user+' AND save_status = 1');
		$('.productNameId').attr('data-id','sale_order');
		$('.productNameId').attr('data-key','id');
		$('.productNameId').attr('data-fieldname','product');
...
/*$(function() {
            $("#npdm").onclick(function() {
                 $("#sale_order").prop("disabled", true);
                 $("#produc_name").prop("disabled", true);
            });
           $("#sale_order").onclick(function() {
                 $("npdm").prop("disabled", true);    
            });
        });
*/
