...
function addMaterialDetail2(well){
    ...
    $(add_mat).click(function(e) {
        ...
        if (y < input) {
            y++;
            $(input_mat).append('<div class="well scend-tr mobile-view" id="chkIndex_' + y + '" ><div class="col-md-6 col-sm-12 col-xs-12 form-group"><label>Check List</label><input style="border-right: 1px solid #c1c1c1 !important;" type="text" name="check_list_data[]" class="form-control col-md-7 col-xs-12  check_list" placeholder="Check List" value=""></div><button class="btn btn-danger remove_input" type="button"><i class="fa fa-minus"></i></button></div>');
...
function addMaterialDetail3() {
    ...
    $(add_mat).click(function(e) {
        ...
        if (y < input) {
            y++;
            $(input_mat).append('<div class="well scend-tr mobile-view" id="chkIndex_' + y + '" ><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;" ><label style="border-right: 1px solid #c1c1c1 !important;">Material Type</label><select class="form-control selectAjaxOption select2 select2-hidden-accessible material_type_id select2" name="material_type[]" data-id="material_type" data-key="id" data-fieldname="name" tabindex="-1" aria-hidden="true" data-where="created_by_cid='+ logged_user +' OR created_by_cid=0"  onchange="getMaterialName(event,this)" id="material_type"><option value="">Select Option</option></select></div><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;" ><label style="border-right: 1px solid #c1c1c1 !important;">Material Name</label><select  class="materialNameId form-control col-md-2 col-xs-12 selectAjaxOption select2 Add_mat_onthe_spot" id="mat_name"  name="material_name[]" onchange="getUom_input(event,this);"><option value="">Select Option</option></select></div><div class="col-md-3 col-sm-12 col-xs-12 form-group"><label>Quantity</label><input style="border-right: 1px solid #c1c1c1 !important;" type="text" name="quantity[]" class="form-control col-md-7 col-xs-12  quantity" placeholder="Quantity" value=""></div><button class="btn btn-danger remove_input" type="button"><i class="fa fa-minus"></i></button></div>');
...
function machineProcess() {
    ...
    $(add_machine).click(function(e) {
        ...
        if (x < machine) {
            ...
            $(machine_detail).append('<div class="well well2 scend-tr" id="chckIndex_' + well + '" data-id="frst_div_' + well + '"><div class="col-md-6 col-sm-12 col-xs-12 vertical-border"><div class="item form-group"><label class="col-md-6 col-sm-12 col-xs-12" for="product detail">Frequency<span class="required">*</span></label><div class="col-md-6 col-sm-12 col-xs-12"><select class="form-control" name="frequency_data[]"><option value="">Select Option</option><option value="daily">Daily</option><option value="weekly">Weekly</option><option value="monthly">Monthly</option><option value="hafe yearly">Hafe Yearly</option><option value="yearly">Yearly</option></select></div></div></div><div class="col-md-6 col-sm-12 col-xs-12 vertical-border"><div class="item form-group"><label class="col-md-3 col-sm-2 col-xs-4" for="description">Start date</label><div class="col-md-7 col-sm-10 col-xs-8"><input type="datetime-local" class="form-control has-feedback-left datePicker" name="start_date[]" id="start_date" value=""><span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span><span id="inputSuccess2Status3" class="sr-only">(success)</span></div></div></div><div class="item form-group "><div class="col-md-12 col-sm-12 col-xs-12 input_fields_wrapsub" data-id="' + well + '"><div class="item form-group"><div class="col-md-12 input_holdersub middle-box" data-id="' + well + '"><div class="wellsub" id="chkIndex_1" data-id="' + well + '" style=" overflow:auto;"><div class="col-md-6 col-sm-12 col-xs-12 form-group" style="padding:0px;"><label style="border-right: 1px solid #c1c1c1 !important;">Check List</label><input style="border-right: 1px solid #c1c1c1 !important;" type="text" name="check_list_data[]" class="form-control col-md-7 col-xs-12 check_list" placeholder="Check List" value=""></div><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;"><div class="input-group-append"><button class="btn edit-end-btn addmaterialsub" data-id="' + well + '" type="button"><i class="fa fa-plus"></i></button></div></div></div></div></div></div></div><div class="item form-group "><div class="col-md-12 col-sm-12 col-xs-12 input_fields_wrap2sub"><div class="item form-group2"><div class="col-md-12 input_holder2sub middle-box"><div class="well2sub" id="chkIndex_1" style=" overflow:auto;"><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;"><label style="border-right: 1px solid #c1c1c1 !important;">Material Type</label><select class="form-control selectAjaxOption select2 select2-hidden-accessible material_type_id select2" name="material_type[]" data-id="material_type" data-key="id" data-fieldname="name" tabindex="-1" aria-hidden="true" data-where="created_by_cid='+ logged_user +' OR created_by_cid=0"  onchange="getMaterialName(event,this)" id="material_type"><option value="">Select Option</option></select></div><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;"><label style="border-right: 1px solid #c1c1c1 !important;">Material Name</label><select  class="materialNameId form-control col-md-2 col-xs-12 selectAjaxOption select2 Add_mat_onthe_spot" id="mat_name"  name="material_name[]" onchange="getUom_input(event,this);"><option value="">Select Option</option></select></div><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;"><label style="border-right: 1px solid #c1c1c1 !important;">Quantity</label><input style="border-right: 1px solid #c1c1c1 !important;" type="text" name="quantity[]" class="form-control col-md-7 col-xs-12 quantity" placeholder="Quantity" value=""></div><div class="col-md-3 col-sm-12 col-xs-12 form-group" style="padding: 0px;"><div class="input-group-append"><button class="btn edit-end-btn addmaterial2sub" type="button"><i class="fa fa-plus"></i></button></div></div></div></div></div></div></div><button class="btn btn-danger remove_machine" type="button"><i class="fa fa-minus"></i></button></div>');
